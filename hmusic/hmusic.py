...
def get_amplitude_at_time(file_path, time_sec):
    ...
    with wave.open(file_path, 'rb') as wav_file:
        ...
        # Set the read position to the desi#ff1f83 frame
...
def play_music(file,time,con=0):
    ...
    if play_st==1:
        ...
        start_time = time  # Replace with the desi#ff1f83 starting time in seconds
...
def main():
    ...
    #cp_im=create_polygon(*ar, fill="#ff1f83", alpha=0.6,can=can2)
    ...
    if select_st==1:
        ...
        if st==0:
            ...
            if playlist_st==0:
                ...
                create_polygon(*ar, fill="#ff1f83", alpha=0.4,can=can2)

                if _npl==1:

                    can2.create_oval(10,y, 10+30,y+30, fill="#550a2b",outline="#550a2b")
                    can2.create_oval((int(can2["width"])-sb_sz-1)-10-30,y, (int(can2["width"])-sb_sz-1)-10,y+30,fill="#550a2b",outline="#550a2b")

                    can2.create_rectangle(10+15,y, (int(can2["width"])-sb_sz-1)-10-15,y+30,fill="#550a2b",outline="#550a2b")
...
def draw_can():
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",12),fill="#ff1f83")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            create_polygon(*ar, fill="#ff1f83", alpha=0.4,can=can)
            
            if _search==1:

                can.create_oval(10,40+30-10-5-5, 10+30,40+30+30-10-5-5,fill="#550a2b",outline="#550a2b")
                can.create_oval(w-10-30-1,40+30-10-5-5, w-10-1,40+30+30-10-5-5,fill="#550a2b",outline="#550a2b")

                can.create_rectangle(10+15,40+30-10-5-5, w-10-15-1,40+30+30-10-5-5,fill="#550a2b",outline="#550a2b")
...
def drag_can(e):
    ...
    if v_st==1:
        ...
        if w-10-100<=e.x<=w-10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5+10-3 ,w-10-100+current_volume*r,h-20-30+5+10-3,fill="#ff1f83",width=2)

            vol2=can.create_text(w-10,h-20-30+5+10-3+12,text=str(int(current_volume*100))+"%",fill="#ff1f83",font=("FreeMono",11),anchor="e")
...
npl=tk.Entry(bg="#550a2b",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=112,font=("FreeMono",13))

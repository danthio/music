...
def main():
    ...
    def round_(r,y):
        ...
        can2.create_polygon(ar,fill="#111111",outline="#111111")
    ...
    if st==0:
        ...
        if playlist_st==0:
            ...
            draw_round_rec(can,10-2,80-10-30+40,w-10,80-30+40+390+10,15,"#777777","",1)
            ...
            can2.create_line(0,y, int(can2["width"]),y,fill="#32fca7")
            ...
            for pl in playlist:
                ...
                if not pl.lower().find(search_var.lower())==-1:
                    ...
                    if current_playlist!=pl:
                        can2.create_line(0,y+50, int(can2["width"]),y+50,fill="#32fca7")
...
def load_im():
    ...
    global circle,play,pause,add,favourite1,favourite2,list1,list2,musical_note1,musical_note2,remove,rename,speaker,previous,next_
    global cancel1,cancel2,search_im,shuffle1,shuffle2,dots,note,playlist1,playlist2,checked,sort,delete,favourite1_,favourite2_,delete2,playlist3,sort2,loop1,loop2,wallpaper,wallpaper2
    global circle2,circle3
...
sort_st=0
_sort=0
can_sort=tk.Canvas(bg="#323232",width=250,height=160,relief="flat",highlightthickness=0,border=0)

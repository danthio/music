...
def add_playlist():
    ...
    cp2_im=create_polygon(*ar, fill="#ff1f83", alpha=0.17,can=can3)
        ...
        if cx-12.5<=e.x<=cx+12.5:
            if cy-12.5<=e.y<=cy+12.5:
                ...
                if sort_st==1:
                    ...
                    csv_im=create_polygon(*ar, fill="#ff1f83", alpha=0.17,can=can_sort)
...
def main():
    ...
    cp_im=create_polygon(*ar, fill="#ff1f83", alpha=0.17,can=can2)

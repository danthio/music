...
im=Image.open("data/arc.png")
im=im.resize((30,30))
im2=im.rotate(-90)
im3=im.rotate(-180)
im4=im.rotate(-270)
im.save("data/arc1.png")
im2.save("data/arc2.png")
im3.save("data/arc3.png")
im4.save("data/arc4.png")
    ...
    if not select_st==1:
        ...
        if not tot_tm_==0:
            ...
            if not current_playing=="":
                ...
                prog1=can.create_line(10,h-20-60-20+10+2+5-3+10, x_+10,h-20-60-20+10+2+5-3+10,fill=col1,width=3)
...
def add_playlist():
    ...
    for p in playlist:
        ...
        #can3.create_line(0,y+50,550-7,y+50,fill="#19030d")
...
def check_volume():
    ...
    if volume.GetMasterVolumeLevelScalar()!=current_volume:
        ...
        vol1=can.create_line(w-10-100,h-20-30+5+10-3 ,w-10-100+current_volume*r,h-20-30+5+10-3,fill=col1,width=3)
    ...
    if select_st==1:
        ...
        if st==0:
            ...
            if playlist_st==0:
                ...
                can2.create_text(30,y+15,text="New Playlist",font=("FreeMono",13),fill="#ff1f83",anchor="w")
...
def draw_can():
    ...
    if lst==1:
        ...
        if st==4:
            ...
            can.create_text(10+15+20+10,40+15+30-10-5-5,text="Search",font=("FreeMono",13),fill="#ff1f83",anchor="w")
    ...
    if select_st==1:
        ...
        can.create_line(10,h-20-60-20+10+2+5-3+10,w-10,h-20-60-20+10+2+5-3+10,fill=col2,width=3)
...
def drag_can(e):
    ...
    if v_st==1:
        ...
        if w-10-100<=e.x<=w-10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5+10-3 ,w-10-100+current_volume*r,h-20-30+5+10-3,fill="#ff1f83",width=3)
...
frame2=tk.Frame(bg="#19030d",width=350+100+100,height=250)

can4=tk.Canvas(frame2,bg="#19030d",width=350+100+100,height=40,relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,300-7,250))
can4.pack(side=tk.TOP)



frame3=tk.Frame(frame2,bg="#19030d",width=350+100+100,height=250-40)
...
psb2_h=0
sb2_st=0
can3=tk.Canvas(frame3,bg="#19030d",width=350+100+100,height=250-40+50,relief="flat",highlightthickness=0,border=0,
...
can6=tk.Canvas(frame2,bg="#19030d",width=350+100+100,height=17,relief="flat",highlightthickness=0,border=0)

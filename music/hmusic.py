    ...
    if play_st==1:
        ...
        try:
            ...
            for a in sig:
                ...
                sig2.append(x)
                sig2.append(a+(80-30+40-10-30)+((450*h/680)+10+30)/2)
            ...
            try:
                ...
                if lst==0 and st!=4:
                    ...
                    sig_=can.create_line(sig2,fill="cyan")
            except:
                pass
...
def get_amplitude_at_time(file_path, time_sec):
    ...
    with wave.open(file_path, 'rb') as wav_file:
        ...
        # Set the read position to the desicyan frame
...
def convert_folder_to_audio():
    ...
    if convert==1:
        ...
        if st==4:
            ...
            load=can.create_text(w/2,493-20-40-30,text="...",font=("FreeMono",25),fill="cyan")
        ...
        if st==4:
            ...
            load2=can.create_oval(w/2-50,493-20-40-30-15, w/2-50+30,493-20-40-30+15,fill="cyan",outline="cyan")
            load3=can.create_oval(w/2+50-30,493-20-40-30-15, w/2+50,493-20-40-30+15,fill="cyan",outline="cyan")
            load4=can.create_rectangle(w/2-50+15,493-20-40-30-15, w/2+50-15,493-20-40-30+15,fill="cyan",outline="cyan")
...
def prog():
    ...
    ctime=can.create_text(10,h-20-60-20+20+10,text=tt,font=("FreeMono",13),fill="cyan",anchor="w")
    ...
    prog1=can.create_line(10,h-20-60-20+10, x_+10,h-20-60-20+10,fill="cyan",width=4)
    prog2=can.create_oval(x_+10-5,h-20-60-20-5+10, x_+10+5,h-20-60-20+5+10,fill="#000000",outline="cyan")
...
def can2_b1(e):
    ...
    if st==2 and playlist_st==0:
        ...
        if 10<=e.x<=int(can2["width"])-10:
            if 5<=e.y<=35:
                ...
                can2["scrollregion"]=(0,0,w-7,(450*h/680))
                npl.delete(0,tk.END)
                _npl=1
                npl.place(in_=root,x=10+15,y=80-30+40+5+5)
                npl.focus_set()
                main()
    ...
    for s in songs:
        ...
        cx,cy=w-7-10-30-20-30-20-30+15,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
    ...
    for s in songs:
        ...
        cx,cy=w-7-10-30-20-30+15,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
                ...
                if add_st==1:
                    ...
                    for p in playlist:
                        ...
                        can3.create_text(10+30+10,y+25,text=p,font=("FreeMono",13),anchor="w",fill="cyan")
    ...
    for a in range(len(songs)):
        ...
        cx,cy=w-7-10-30+10,songs[a][-1]+15+10
    ...
    if not current_playing=="":
        ...
        for s in songs:
            ...
            if s[0]==current_playing:
                ...
                if s[1]+(450*h/680)/2-25<t:
                    v=s[1]-((450*h/680)/2-25)
...
def can_b1(e):
    ...
    if 10<=e.x<=w-10-5-30:
        if 40<=e.y<=40+30:
            ...
            can.create_arc(10,40, 10+30,40+30, style=tk.ARC,start=90,extent=180,outline="cyan")
            can.create_arc(w-10-30,40, w-10,40+30, style=tk.ARC,start=270,extent=180,outline="cyan")

            can.create_line(10+15,40, w-10-15,40, fill="cyan")
            can.create_line(10-1+15,40+30, w-10-15,40+30, fill="cyan")
    ...
    if w-10-100-10<=e.x<=w-10+10:
        if h-20-30+5-10+10<=e.y<=h-20-30+5+10+10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5+10 ,w-10-100+current_volume*r,h-20-30+5+10,fill="cyan",width=3)
            vol2=can.create_oval(w-10-100+current_volume*r-5,h-20-30+5-5+10, w-10-100+current_volume*r+5,h-20-30+5+5+10,fill="#000000",outline="cyan")

            vol3=can.create_text(w-10-100+50,h-20-30+5+20+10-2,text=str(int(current_volume*100))+" %",fill="cyan",font=("FreeMono",13))
    ...
    if r<=15:
        ...
        if sort_st==1:
            ...
            can_sort.place(in_=root,x=10+30+20+30+10,y=h-20-30-15+5-160)
    ...
    if st==4:
        ...
        yv=(((450*h/680)+10+30)-(30+30+30))/2
        yv+=39+30


        #can.create_rectangle(w/2-150,yv, w/2+150,yv+30, fill="cyan")
...
def play_music(file,time,con=0):
    ...
    start_time = time  # Replace with the desicyan starting time in seconds
...
def main():
    ...
    if root.wm_attributes("-fullscreen")==1:
        ...
        frame["width"]=w
        frame["height"]=(450*h/680)+30

        can2["width"]=w-7
        can2["height"]=(450*h/680)+30
    else:

        frame["width"]=w
        frame["height"]=(450*h/680)

        can2["width"]=w-7
        can2["height"]=(450*h/680)
    ...
    for l in range(len(label)):
        ...
        if l==st:
            ...
            can.create_rectangle(x-60+15,5, x+60-15,35-1, fill="cyan",outline="cyan")
        ...
        #can.create_rectangle(x-50,20-10, x+50,20+10, outline="cyan")
    ...
    #hex(can,-30,-30,w+60,h+60,30,"#280200","#000000")
    ...
    if lst==1 and st!=4:
        ...
        #can.create_line(5,80-30+40-5,w-7,80-30+40-5,fill="#003538")

        #can.create_rectangle(0,40+30+1,w,80-30+40+5+int(can2["height"]),fill="#000000",outline="#000000")
        can.create_line(10,80-30+40+5+int(can2["height"]),w-10,80-30+40+5+int(can2["height"]),fill="cyan")
    ...
    if st==0:
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if song==current_playing:
                    ...
                    can2.create_image(5,y,image=circle2,anchor="nw")
                    can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")

                    can2.create_rectangle(25+5,y, int(can2["width"])-25,y+50-1,fill="cyan",outline="cyan")
                ...
                can2.create_text(10+30+10,y+25,text=song,font=("FreeMono",13),fill=col,anchor="w")
                if song==current_playing:
                    can2.create_rectangle(w-7-10-30-20-30-20-30-10,y+5, w-7-30,y+45,fill="cyan",outline="cyan")
                    can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                else:
                    can2.create_rectangle(w-7-10-30-20-30-20-30-10,y+5, w-7,y+45,fill="#000000",outline="#000000")
                ...
                can2.create_image(w-7-10-30,y+10,image=_del_,anchor="nw")
                ...
                can2.create_image(w-7-10-30-20-30,y+10,image=_pl_,anchor="nw")
                ...
                can2.create_image(w-7-10-30-20-30-20-30,y+10,image=_fv_,anchor="nw")
        ...
        if len(songs)==0:
            ...
            can2.create_text((w-7)/2,(450*h/680)/2,text="No Record!",font=("FreeMono",13),fill="cyan")
        ...
        if playlist_st==0:
            ...
            can.create_text(30+20+5,40+15,text="Search",font=("FreeMono",13),fill="cyan",anchor="w")
            ...
            #draw_round_rec(can,10-2,80-10-30+40,w-10,80-30+40+(450*h/680)+10,15,"#137345","",1)
            #can.create_line(10,70,w-10,70,fill="cyan")
            #can.create_line(10,80+h-240+10,w-10,80+h-240+10,fill="cyan")
            ...
            can2.create_arc(10,y, 10+30,y+30, style=tk.ARC,start=90,extent=180,outline="cyan")
            can2.create_arc(int(can2["width"])-10-30,y, int(can2["width"])-10,y+30, style=tk.ARC,start=270,extent=180,outline="cyan")

            can2.create_line(10+15,y, int(can2["width"])-10-15,y, fill="cyan")
            can2.create_line(10-1+15,y+30, int(can2["width"])-10-15,y+30, fill="cyan")
            ...
            can2.create_text(30,y+15,text="New Playlist",font=("FreeMono",13),fill="cyan",anchor="w")
            ...
            #can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30, outline="cyan")

            can2.create_image(int(can2["width"])/2-100-15,y,image=circle3,anchor="nw")
            can2.create_image(int(can2["width"])/2+100-15,y,image=circle3,anchor="nw")

            can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30-1,fill="cyan",outline="cyan")
            ...
            for pl in playlist:
                ...
                if scon==1:
                    ...
                    can2.create_image(10+5,y+10,image=_pl_,anchor="nw")




                    can2.create_text(10+30+10+5,y+25,text=pl,font=("FreeMono",13),fill=col,anchor="w")
            ...
            if len(_playlist)==0:
                current_playing=""
                can2["width"]=w-7+30
                can2.create_text(int(can2["width"])/2,y+((450*h/680)-y)/2,text="No Record",font=("FreeMono",13),fill="cyan")
        ...
        can.create_rectangle(w/2-80,yv, w/2+80,yv+30-1,fill="cyan",outline="cyan")
        ...
        can.create_rectangle(w/2-80,yv+60, w/2+80,yv+30-1+60,fill="cyan",outline="cyan")
    ...
    """
    if y<=(450*h/680):
        hex(can2,-30,-30,w+60,int(can2["height"])+60,30,"#280200","#000000")


    else:

        hex(can2,-30,-30,w+60,y+60,30,"#280200","#000000")
    ...
    if lst==1:
        ...
        if st==2 and playlist_st==0 and pl_st==0:
            ...
            #draw_round_rec(can,10,40, w-10,40+30,10,"#000000","cyan",0)
        ...
        if playlist_st==0 and st==2:
            ...
            if root.wm_attributes("-fullscreen")==1:
                can.create_image((w-400)/2,39+((450*h/680)+10+30)/2-210+30+10,image=note,anchor="nw")
            else:
                can.create_image((w-400)/2,39+((450*h/680)+10+30)/2-210+10,image=note,anchor="nw")
    ...
    if playlist_st==0 and st==2 and pl_st==0 :
        ...
        if len(current_playlist)>0:
            ...
            can.create_image(10,h-20-60-20-27-15+3+10, image=circle3,anchor="nw")
            can.create_image(10+15+length_in_pixels-15+30,h-20-60-20-27-15+3+10, image=circle3,anchor="nw")
            can.create_rectangle(10+15,h-20-60-20-27-15+3+10, 10+15+length_in_pixels+30,h-20-60-20-27+14+3+10,fill="cyan",outline="cyan")
            can.create_image(10+15,h-20-60-20-27-15+3+10+5, image=playlist4,anchor="nw")

            can.create_text(10+15+30,h-20-60-20-27+3+10,text=current_playlist,font=("FreeMono",13,),anchor="w",fill="#000000")
                  
            can.create_text(10+15+length_in_pixels+15+10+30,h-20-60-20-27+3+10,text=current_playing,font=("FreeMono",13),anchor="w",fill="cyan")
        else:
            can.create_text(10,h-20-60-20-27+3+10,text=current_playing,font=("FreeMono",13),anchor="w",fill="cyan")
        ...
        if not current_playing=="":
            ...
            can.create_rectangle(w-10-l-10, h-20-60-20-27+3-13+10, w, h-20-60-20-27+3+13+10,fill="#000000",outline="#000000")

            can.create_text(w-10,h-20-60-20-27+3+10,text=t,font=("FreeMono",13),anchor="e",fill="cyan")
    ...
    if st==2 and playlist_st==0:
        ...
        can.create_text(w-10,h-20-60-20+20+10,text=tot_tm,font=("FreeMono",13),anchor="e",fill="cyan")
    ...
    can.create_line(w-10-100,h-20-30+5+10, w-10,h-20-30+5+10,fill="#003538",width=3)

    can.create_image(w-10-100-10-30,h-20-30-15+5+10,image=speaker,anchor="nw")
...
def load_im():
    ...
    global circle2,circle3,expand,expand2,playlist4
...
def load_():
    ...
    if st==4 and load_st==1:
        ...
        load=can.create_arc(w/2-20,493-20-40, w/2+20,493-20,outline="cyan",width=2,style=tk.ARC,start=load_ang,extent=270)
...
style.configure("My.Vertical.TScrollbar", gripcount=0, background="cyan",
...
style2.configure("My.Vertical.TScrollbar2", gripcount=0, background="cyan",
...
def _on_mousewheel(e):
    ...
    if add_st==0:
        ...
        if int(can2["scrollregion"].split(" ")[-1])>(450*h/680):
...
frame=tk.Frame(bg="#000000",width=w,height=(450*h/680))

can2=tk.Canvas(frame,bg="#000000",width=w-7,height=(450*h/680),relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,w-7,(450*h/680)))
can2.pack(side=tk.LEFT)
...
can4.create_text(350/2,20,text="Playlists",font=("FreeMono",13),fill="cyan")
can4.create_line(0,38,350,38,fill="cyan")
...
search=tk.Entry(bg="#000000",fg="cyan",insertbackground="cyan",relief="flat",highlightthickness=0,border=0,width=86,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#000000",fg="cyan",insertbackground="cyan",relief="flat",highlightthickness=0,border=0,width=84,font=("FreeMono",13))
...
can_sort.create_text(125,15,text="Sort",font=("FreeMono",13),fill="cyan")


can_sort.create_line(0,30, 250,30,fill="cyan" )
...
for _ in a:
    ...
    can_sort.create_text(20,y+15,text=_,font=("FreeMono",13),fill="cyan",anchor="w")

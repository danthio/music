            ...
            for song in all_songs:
                ...
                if scon==1:
                    ...
                    if song==current_playing:
                        ...
                        can2.create_rectangle(int(can2["width"])-25*3-15*3,y+5, int(can2["width"])-3,y+45,fill=col1,outline=col1)
                    else:
                    ...
                    if scon==1:
                        ...
                        try:
                            ...
                            if song==current_playing:
                                ...
                                can2.create_rectangle(int(can2["width"])-25*4-15*3,y+3, int(can2["width"])-3,y+45,fill=col1,outline=col1)
...
def draw_can():
    ...
    if lst==1:
        ...
        if st==4:
            ...
            frame.place(in_=root,x=11,y=80-30+40+30-10-3-10)
    else:
...
def load_im():
    ...
    red=ImageTk.PhotoImage(file="data/red.png")
    mint=ImageTk.PhotoImage(file="data/mint.png")
    cyan=ImageTk.PhotoImage(file="data/cyan.png")

    paste=ImageTk.PhotoImage(file="data/paste.png")

    video1=ImageTk.PhotoImage(file="data/video1.png")
    video2=ImageTk.PhotoImage(file="data/video2.png")
    video3=ImageTk.PhotoImage(file="data/video3.png")
    eye=ImageTk.PhotoImage(file="data/eye.png")

...
def prog():
    ...
    global circle9,circle5,circle7,circle8
    ...
    if not select_st==1:
        ...
        if not tot_tm_==0:
            ...
            if not current_playing=="":
                ...
                ctime=can.create_text(10,h-20-60-20+20+10+5-3+5-2,text=tt,font=("FreeMono",11),fill=col1,anchor="w")
...
def can3_b1(e):
    ...
    if int(can3["width"])-sb2_sz-4<=e.x<=int(can3["width"])-4:
...
def add_playlist():
    ...
    #x=(w-450)/2,y=(h-(40+250-40+10))/2

    can4.create_image(-((w-450)/2),-((h-(40+250-40+10))/2),image=bg,anchor="nw")
    can6.create_image(-((w-450)/2),-((h-(40+250-40+10))/2+250),image=bg,anchor="nw")


    can4.create_text(450/2,20,text="Playlists",font=("FreeMono",12),fill=col1)
    can4.create_line(2,38,450-2,38,fill=col1)

    draw_round_rec(can4,1,2 ,450-2,80,15,col1,"",1)

    draw_round_rec(can6,1,-15 ,450-2,15,15,col1,"",1)
    ...
    bgp=can3.create_image(-((w-450)/2),-((h-(40+250-40+10))/2+40)+int(can3.canvasy(0)),image=bg,anchor="nw")
    ...
    for p in playlist:
        ...
        #can3.create_line(0,y+50,450-7,y+50,fill="#01283b")
    ...
    if y<250-40:
        ...
        can3.create_line(1,0, 1,250-40,fill=col1)
        can3.create_line(450-2,0, 450-2,250-40,fill=col1)
    else:

        can3.create_line(1,0, 1,y,fill=col1)
        can3.create_line(450-2,0, 450-2,y,fill=col1)


    if len(playlist)==0:
        can3.create_text(10+30+10,(250-40)/2,text="No record",font=("FreeMono",12),anchor="w")
...
def can2_b1(e):
    ...
    if (int(can2["width"])-sb_sz-1)<=e.x<=(int(can2["width"])-1):
        ...
        if cx-12.5<=e.x<=cx+12.5:
            if cy-12.5<=e.y<=cy+12.5:
                ...
                if sort_st==1:
                    ...
                    can_sort.create_text(125,15,text="Sort",font=("FreeMono",12),fill=col1)
                    ...
                    for _ in sa:
                        ...
                        #can_sort.create_line(0,y+30,250,y+30,fill="#01283b")
...
def main():
    ...
    style.configure("My.Vertical.TScrollbar", gripcount=0, background=col1,
                    troughcolor="#006b7a", borderwidth=0, bordercolor="#006b7a",
                    lightcolor="#006b7a",relief="flat", darkcolor="#006b7a",
                    arrowsize=6)

    style.map("My.Vertical.TScrollbar",
              background=[('active', col1), ('!active', col1)],  # Semi-opaque thumb
              troughcolor=[('active', "#006b7a"), ('!active', "#006b7a")])


    style2.configure("My.Vertical.TScrollbar2", gripcount=0, background=col1,
                    troughcolor='#3f1808', borderwidth=0, bordercolor='#3f1808',
                    lightcolor='#3f1808',relief="flat", darkcolor='#3f1808',
                    arrowsize=6)
    ...
    if select_st==1:
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                can2.create_text(50,y+25,text=_text_(can2,song[:-4],"FreeMono",12,(int(can2["width"])-20-20-20)-50),font=("FreeMono",12),fill=col,anchor="w")
        ...
        if len(songs2)==0:
            ...
            can2.create_text((w-7)/2,((h-121)-80-10)/2,text="No Record!",font=("FreeMono",25),fill=col1)


            style.configure("My.Vertical.TScrollbar", gripcount=0, background="#01283b",
                            troughcolor="#01283b", borderwidth=0, bordercolor="#01283b",
                            lightcolor="#01283b",relief="flat", darkcolor="#01283b",
                            arrowsize=6)
        ...
        #hex(can,-30,-30,w+60,h+60,30,"#390200","#01283b")
        ...
        #can2.create_image(-10,can2.canvasy(-(80-30+40))+h,image=wallpaper,anchor="nw")
        #create_rectangle(can2,0, int(can2.canvasy(0))-h, int(can2["width"]), int(can2.canvasy(int(can2["height"])))+h, fill='#01283b', alpha=.65)
        ...
        if st==0:
            ...
            for song in all_songs:
                ...
                if scon==1:
                    ...
                    can2.create_text(50,y+50/2,text=_text_(can2,song[:-4],"FreeMono",12,((int(can2["width"])-sb_sz-1)-25*3-15*3-10)-50),font=("FreeMono",12),fill=col,anchor="w")




                    can2.create_image((int(can2["width"])-sb_sz-1)-10-25,y+12.5,image=_del_,anchor="nw")
            ...
            if len(songs)==0:
                ...
                can2.create_text((int(can2["width"])-sb_sz-1)/2,int(can2["height"])/2,text="No Record!",font=("FreeMono",25),fill=col1)
            ...
            if playlist_st==0:
                ...
                if _search==1:
                    ...
                    can.create_oval(10,40, 10+30,40+30,fill="#002935",outline="#002935")
                    can.create_oval(w-10-30,40, w-10,40+30,fill="#002935",outline="#002935")

                    can.create_rectangle(10+15,40, w-10-15,40+30,fill="#002935",outline="#002935")
                ...
                can.create_text(30+20+5,40+15,text="Search",font=("FreeMono",12),fill=col1,anchor="w")
                ...
                #can2.create_rectangle(0,0, (int(can2["width"])-sb_sz-1),95,fill=col3,outline=col3)
                ...
                create_polygon(*ar, fill="#00ffff", alpha=0.4,can=can2)

                if _npl==1:

                    can2.create_oval(10,y, 10+30,y+30, fill="#01283b",outline="#01283b")
                    can2.create_oval((int(can2["width"])-sb_sz-1)-10-30,y, (int(can2["width"])-sb_sz-1)-10,y+30,fill="#01283b",outline="#01283b")

                    can2.create_rectangle(10+15,y, (int(can2["width"])-sb_sz-1)-10-15,y+30,fill="#01283b",outline="#01283b")
                ...
                can2.create_text(30,y+15,text="New Playlist",font=("FreeMono",12),fill=col1,anchor="w")
                ...
                can2.create_text((int(can2["width"])-sb_sz-1)/2,y+15,text="Create New Playlist",font=("FreeMono",12),fill="#01283b")
                ...
                for pl in playlist:
                    ...
                    if scon==1:
                        ...
                        if current_playlist==pl:
                            ...
                            can2.create_image((int(can2["width"])-sb_sz-1)-10-25-15-25,y+12.5,image=add2,anchor="nw")

                        else:

                            can2.create_image((int(can2["width"])-sb_sz-1)-10-25-15-25,y+12.5,image=add,anchor="nw")
                        ...
                        can2.create_text(50,y+25,text=_text_(can2,pl,"FreeMono",12,((int(can2["width"])-sb_sz-1)-25*2-15*2-10)-50),font=("FreeMono",12),fill=col,anchor="w")
            ...
            for song in ar_:
                ...
                can2.create_text(50,y+50/2,text=_text_(can2,song[0][:-4],"FreeMono",12,((int(can2["width"])-sb_sz-1)-25*3-15*3-10)-50),font=("FreeMono",12),fill=col,anchor="w")
        ...
        """
        if y<=((h-121)-80-10):
            hex(can2,-30,-30,w+60,int(can2["height"])+60,30,"#390200","#01283b")


        else:

            hex(can2,-30,-30,w+60,y+60,30,"#390200","#01283b")
...
def draw_can():
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",12),fill="#00ffff")
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",12),fill="#01283b")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            create_polygon(*ar, fill="#00ffff", alpha=0.4,can=can)
            
            if _search==1:

                can.create_oval(10,40+30-10-5-5, 10+30,40+30+30-10-5-5,fill="#01283b",outline="#01283b")
                can.create_oval(w-10-30-1,40+30-10-5-5, w-10-1,40+30+30-10-5-5,fill="#01283b",outline="#01283b")

                can.create_rectangle(10+15,40+30-10-5-5, w-10-15-1,40+30+30-10-5-5,fill="#01283b",outline="#01283b")
            ...
            can.create_text(30+20+5,40+15+30-10-5-5,text="Search",font=("FreeMono",12),fill=col1,anchor="w")
    ...
    for l in range(len(label)):
        ...
        can.create_text(x,50/2,text=label[l],fill=col,font=("FreeMono",12),anchor="c")
    ...
    if select_st==1:
        ...
        if playlist_st==0 and st==2 and pl_st==0 and current_playing=="":
            ...
            try:
                ...
                if songs_status[1]!="":
                        ...
                        can.create_text(10+15+30,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=current_playlist_,font=("FreeMono",12,),anchor="w",fill="#01283b")
                    ...
                    if songs_status[0]==1:
                        ...
                        can.create_text(10+25+10,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=_text_(can2,current_playing[:-4],"FreeMono",12,(w-10)-(10+25+10)),font=("FreeMono",12),anchor="w",fill=col1)
                    else:
                        can.create_text(10,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=_text_(can2,current_playing[:-4],"FreeMono",12,(w-10)-(10)),font=("FreeMono",12),anchor="w",fill=col1)
        ...
        if st==2 and playlist_st==0 and current_playing=="":
            ...
            if not current_playing=="":
                can.create_text(w-10,h-20-60-20+20+10+5-3+5-2,text=tot_tm,font=("FreeMono",11),anchor="e",fill=col1)
    ...
    if st==4:
        ...
        can.create_text(w/2,yv+15,text="Add Folder",fill="#01283b",font=("FreeMono",12))
        ...
        can.create_text(w/2,yv+15+60,text="Add Audio File",fill="#01283b",font=("FreeMono",12))
    ...
    if select_st==1:
        ...
        can.create_text(x+30+5,(h-121+75)+((h-1)-(h-121+75))/2,text=playlist_select,font=("FreeMono",12),fill=col1,anchor="w")
        ...
        if lst==0:
            ...
            if not current_playing=="":
                ...
                if not _lyric_=="":
                    ...
                    can.create_text(w/2,50+(((h-121)-50)-420)/2+210,text="Nothing to show!",fill=col1,font=("FreeMono",25))
...
def load_im():
    ...
    copy=ImageTk.PhotoImage(file="data/copy.png")
...
def move_bg():
    ...
    if int(can_lyrics.canvasy(0))!=y2:

        can_lyrics.coords(bg2,-10,-(50)+int(can_lyrics.canvasy(0)))

        y2=int(can_lyrics.canvasy(0))

    if int(can3.canvasy(0))!=y3:

        

        can3.coords(bgp,-((w-450)/2),-((h-(40+250-40+10))/2+40)+int(can3.canvasy(0)))

        y3=int(can3.canvasy(0))
...
def drag_can(e):
    ...
    if v_st==1:
        ...
        if w-10-100<=e.x<=w-10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5+10-3 ,w-10-100+current_volume*r,h-20-30+5+10-3,fill="#00ffff",width=2)

            vol2=can.create_text(w-10,h-20-30+5+10-3+12,text=str(int(current_volume*100))+"%",fill="#00ffff",font=("FreeMono",11),anchor="e")
...
can=tk.Canvas(width=w,height=h,bg="#01283b",relief="flat",highlightthickness=0,border=0,cursor="arrow")
...
frame=tk.Frame(bg="#01283b",width=w-20,height=((h-121)-80-10))
    ...
    if sb_st==1:
        ...
        if not e.y<0:
            ...
            if not e.y+h>int(can2["height"]):
                ...
                sb_move(int(can2["height"])-h-1,(int(can2["height"])-h-1)*int(can2["scrollregion"].split(" ")[-1])/int(can2["height"]))
...
def draw_sb():
    global can2
    global sb,sb_sz,sb_region,sb_h
    ...
    sb=can2.create_rectangle(int(can2["width"])-sb_sz-1,can2.canvasy(sb_h),int(can2["width"])-1,can2.canvasy(sb_h+h),fill=sb_col,outline=sb_col)
...
can2=tk.Canvas(frame,bg="#01283b",width=w-20,height=((h-121)-80-10),relief="flat",highlightthickness=0,border=0)
can2["scrollregion"]=(0,0,int(can2["width"]),int(can2["height"]))
...
frame2=tk.Frame(bg="#01283b",width=350+100,height=250)

can4=tk.Canvas(frame2,bg="#01283b",width=350+100,height=40,relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,300-7,250))
can4.pack(side=tk.TOP)



frame3=tk.Frame(frame2,bg="#01283b",width=350+100,height=250-40)
    ...
    if sb2_st==1:
        ...
        if not e.y<0:
            ...
            if not e.y+h>int(can3["height"]):
                ...
                sb2_move(int(can3["height"])-h-1,(int(can3["height"])-h-1)*int(can3["scrollregion"].split(" ")[-1])/int(can3["height"]))
...
def draw_sb2():
    global can3
    global sb2,sb2_sz,sb2_region,sb2_h
    ...
    sb2=can3.create_rectangle(int(can3["width"])-sb2_sz-4,can3.canvasy(sb2_h),int(can3["width"])-4,can3.canvasy(sb2_h+h),fill=sb2_col,outline=sb2_col)
...
psb2_h=0
sb2_st=0
can3=tk.Canvas(frame3,bg="#01283b",width=350+100,height=250-40,relief="flat",highlightthickness=0,border=0,
...
can6=tk.Canvas(frame2,bg="#01283b",width=350+100,height=17,relief="flat",highlightthickness=0,border=0)
...
search=tk.Entry(bg="#01283b",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=115,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#01283b",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=112,font=("FreeMono",13))
...
sort_st=0
_sort=0
can_sort=tk.Canvas(bg="#01283b",width=250,height=160,relief="flat",highlightthickness=0,border=0)
...
can_lyrics=tk.Canvas(bg="#01283b",relief="flat",highlightthickness=0,border=0)

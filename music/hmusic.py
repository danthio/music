...
def initialize_ui(root, video_path):
    ...
    vid_label.place(in_=root,x=6,y=56)
...
def can2_b1(e):
    ...
    if st==2 and playlist_st==0:
        ...
        if 10<=e.x<=int(can2["width"])-10:
            if 5<=e.y<=35:
                ...
                npl.delete(0,tk.END)
                _npl=1
                npl.place(in_=root,x=10+15+10,y=80-30+40+5+5)
                npl.focus_set()
                main()
    ...
    for s in songs:
        ...
        cx,cy=int(can2["width"])-10-30-20-30-20-30-20-30+15,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
    ...
    for s in songs:
        ...
        cx,cy=int(can2["width"])-10-30-20-30-20-30+15,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
    ...
    for s in songs:
        ...
        cx,cy=int(can2["width"])-10-30-20-30+15,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
    ...
    for s in songs:
        ...
        cx,cy=int(can2["width"])-10-30+15,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
...
def can_b1(e):
    ...
    if theme_st==1:
        ...
        cx,cy=w-80-130/2+10+15+15,5+30+5+15
        ...
        cx,cy=w-80-130/2+10+30+10+15+15,5+30+5+15
        ...
        cx,cy=w-80-130/2+10+30+10+30+10+15+15,5+30+5+15
...
def main():
    ...
    global paste
    global lyric_st
    global add_video1,add_video2,add_video3,add_video4
    global play_video_st
    ...
    if st==0:
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if song==current_playing:
                    can2.create_rectangle(int(can2["width"])-30*4-20*4,y+5, w-7-30,y+45,fill=col1,outline=col1)
                    can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                else:
                    can2.create_rectangle(int(can2["width"])-30*4-20*4,y+5, w-7,y+45,fill="#000000",outline="#000000")
                ...
                if music_details[song][3]==True:
                    ...
                    if song==current_playing:
                        can2.create_image(int(can2["width"])-10-30-20-30,y+10,image=add_video3,anchor="nw")
                    else:

                       can2.create_image(int(can2["width"])-10-30-20-30,y+10,image=add_video2,anchor="nw")
                elif music_details[song][3]==False:

                    if song==current_playing:
                        can2.create_image(int(can2["width"])-10-30-20-30,y+10,image=add_video4,anchor="nw")
                    else:

                        can2.create_image(int(can2["width"])-10-30-20-30,y+10,image=add_video1,anchor="nw")
                ...
                can2.create_image(int(can2["width"])-10-30-20-30-20-30,y+10,image=_pl_,anchor="nw")
                ...
                can2.create_image(int(can2["width"])-10-30-20-30-20-30-20-30,y+10,image=_fv_,anchor="nw")
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if music_details[song][0]==1:
                    ...
                    can2.create_text(10+30,y+25,text=song,font=("FreeMono",13),fill=col,anchor="w")
                    if song==current_playing:
                        can2.create_rectangle(int(can2["width"])-30*4-20*4,y+5, w-7-30-20,y+45,fill=col1,outline=col1)
                        can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                    else:
                        can2.create_rectangle(int(can2["width"])-30*4-20*4,y+5, w-7-20,y+45,fill="#000000",outline="#000000")
...
def draw_can():
    ...
    if lst==1:
        ...
        if st==4:
            ...
            if root.wm_attributes("-fullscreen")==0:
                ...
                draw_round_rec(can,10,80-10-30+40,w-10,80-30+40+(450*h/680)+10,15,"#000000",col1,0)
            elif root.wm_attributes("-fullscreen")==1:
                draw_round_rec(can,10,80-10-30+40,w-10,80-30+40+(450*h/680)+10+30,15,"#000000",col1,0)
    ...
    if theme_st==1:
        ...
        can.create_oval(w-80-130/2+15,5+30, w-80-130/2+40+15,5+30+40,fill=col2,outline=col2)
        can.create_oval(w-80-130/2+130-40+15,5+30, w-80-130/2+130+15,5+30+40,fill=col2,outline=col2)
        can.create_rectangle(w-80-130/2+15+15,5+30, w-80-130/2+130-15+15,5+30+40,fill=col2,outline=col2)
...
def load_im():
    ...
    add_video4=ImageTk.PhotoImage(file="data/"+theme+"/add_video4.png")
...
add_video1,add_video2,add_video3,add_video4=0,0,0,0
...
def play_next(e):
    ...
    global play_video_st,vid_label
...
def play_previous(e):
    ...
    global st,playlist_st,play_st,current_playing,mvar,tm,loop,pp,songs,play_video_st,vid_label
...
frame=tk.Frame(bg="#000000",width=w-20-2,height=(450*h/680))

can2=tk.Canvas(frame,bg="#000000",width=w-7-20-2,height=(450*h/680),relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,w-7-2,(450*h/680)))

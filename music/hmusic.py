        ...
        try:
            ...
            try:
                ...
                if lst==0 and st!=4:
                    ...
                    sig_=can.create_line(sig2,fill="#00ffff")
            except:
                pass
...
def convert_folder_to_audio():
    ...
    if convert==1:
        ...
        if st==4:
            ...
            load=can.create_text(w/2,493-20-40-30,text="...",font=("FreeMono",25),fill="#00ffff")
            ...
            for i in all_items:
                ...
                try:
                    ...
                    if st==4:
                        ...
                        load=can.create_text(10,h-20-60-60,text=i,font=("FreeMono",13),fill="#00ffff",anchor="w")
                    main()
        ...
        if st==4:
            ...
            load2=can.create_oval(w/2-50,493-20-40-30-15, w/2-50+30,493-20-40-30+15,fill="#00ffff",outline="#00ffff")
            load3=can.create_oval(w/2+50-30,493-20-40-30-15, w/2+50,493-20-40-30+15,fill="#00ffff",outline="#00ffff")
            load4=can.create_rectangle(w/2-50+15,493-20-40-30-15, w/2+50-15,493-20-40-30+15,fill="#00ffff",outline="#00ffff")
...
def can2_b1(e):
    ...
    for s in songs:
        ...
        cx,cy=w-7-10-30-20-30-20-30+15-20,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
    ...
    for s in songs:
        ...
        cx,cy=w-7-10-30-20-30+15-20,y+10+15
        r=math.sqrt((e.x-cx)**2+(can2.canvasy(e.y)-cy)**2)
        if r<=15:
                ...
                if add_st==1:
                    ...
                    for p in playlist:
                        ...
                        can3.create_text(10+30+10,y+25,text=p,font=("FreeMono",13),anchor="w",fill="#00ffff")
    ...
    for a in range(len(songs)):
        ...
        cx,cy=w-7-10-30+10-20,songs[a][-1]+15+10
...
def can_b1(e):
    ...
    if 10<=e.x<=w-10-5-30:
        if 40<=e.y<=40+30:
            ...
            can.create_arc(10,40, 10+30,40+30, style=tk.ARC,start=90,extent=180,outline="#00ffff")
            can.create_arc(w-10-30,40, w-10,40+30, style=tk.ARC,start=270,extent=180,outline="#00ffff")

            can.create_line(10+15,40, w-10-15,40, fill="#00ffff")
            can.create_line(10-1+15,40+30, w-10-15,40+30, fill="#00ffff")
    ...
    if w-10-100-10<=e.x<=w-10+10:
        if h-20-30+5-10+10<=e.y<=h-20-30+5+10+10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5+10 ,w-10-100+current_volume*r,h-20-30+5+10,fill="#00ffff",width=3)
            vol2=can.create_oval(w-10-100+current_volume*r-5,h-20-30+5-5+10, w-10-100+current_volume*r+5,h-20-30+5+5+10,fill="#000000",outline="#00ffff")

            vol3=can.create_text(w-10-100+50,h-20-30+5+20+10-2,text=str(int(current_volume*100))+" %",fill="#00ffff",font=("FreeMono",13))
    ...
    if st==4:
        ...
        #can.create_rectangle(w/2-150,yv, w/2+150,yv+30, fill="#00ffff")
...
def main():
    ...
    global playlist4
    global web,web2,web3,web4,cockroach,spider
    ...
    can.create_image(0,0, image=web,anchor="nw")
    can.create_image(0,h, image=web2,anchor="sw")
    can.create_image(w,h, image=web3,anchor="se")
    can.create_image(w,0, image=web4,anchor="ne")

    #can.create_image(273,631, image=cockroach,anchor="nw")
    ...
    for l in range(len(label)):
        ...
        if l==st:
            ...
            can.create_rectangle(x-60+15,5, x+60-15,35-1, fill="#00ffff",outline="#00ffff")
        ...
        #can.create_rectangle(x-50,20-10, x+50,20+10, outline="#00ffff")
    ...
    if lst==1 and st!=4:
        ...
        pass
        #can.create_line(10,80-30+40+5+int(can2["height"]),w-10,80-30+40+5+int(can2["height"]),fill="#003538")
    ...
    if st==0:
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if song==current_playing:
                    ...
                    can2.create_rectangle(25,y, int(can2["width"])-25,y+50-1,fill="#00ffff",outline="#00ffff")
                ...
                if song==current_playing:
                    can2.create_rectangle(w-7-10-30-20-30-20-30-10-20,y+5, w-7-30,y+45,fill="#00ffff",outline="#00ffff")
                    can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                else:
                    can2.create_rectangle(w-7-10-30-20-30-20-30-10-20,y+5, w-7,y+45,fill="#000000",outline="#000000")
                ...
                can2.create_image(w-7-10-30-20,y+10,image=_del_,anchor="nw")
                ...
                can2.create_image(w-7-10-30-20-30-20,y+10,image=_pl_,anchor="nw")
                ...
                can2.create_image(w-7-10-30-20-30-20-30-20,y+10,image=_fv_,anchor="nw")



                if not song==current_playing:

                    can2.create_line(0,y+50,w-10,y+50,fill="#003538")
        ...
        if len(songs)==0:
            ...
            can2.create_text((w-7)/2,(450*h/680)/2,text="No Record!",font=("FreeMono",13),fill="#00ffff")
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if music_details[song][0]==1:
                    ...
                    can2.create_text(10+30,y+25,text=song,font=("FreeMono",13),fill=col,anchor="w")
                    if song==current_playing:
                        can2.create_rectangle(w-7-10-30-20-30-20-30-10-20,y+5, w-7-30-20,y+45,fill="#00ffff",outline="#00ffff")
                        can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                    else:
                        can2.create_rectangle(w-7-10-30-20-30-20-30-10-20,y+5, w-7-20,y+45,fill="#000000",outline="#000000")
                    ...
                    if not song==current_playing:
                        ...
                        can2.create_line(0,y+50,w-10-20,y+50,fill="#003538")
        ...
        if playlist_st==0:
            ...
            can.create_text(30+20+5,40+15,text="Search",font=("FreeMono",13),fill="#00ffff",anchor="w")
            ...
            if root.wm_attributes("-fullscreen")==0:

                draw_round_rec(can,10-2,80-10-30+40,w-10,80-30+40+(450*h/680)+10,15,"#000000","#00ffff",0)
            elif root.wm_attributes("-fullscreen")==1:
                draw_round_rec(can,10-2,80-10-30+40,w-10,80-30+40+(450*h/680)+10+30,15,"#000000","#00ffff",0)
            ...
            can2.create_arc(10,y, 10+30,y+30, style=tk.ARC,start=90,extent=180,outline="#00ffff")
            can2.create_arc(int(can2["width"])-10-30,y, int(can2["width"])-10,y+30, style=tk.ARC,start=270,extent=180,outline="#00ffff")

            can2.create_line(10+15,y, int(can2["width"])-10-15,y, fill="#00ffff")
            can2.create_line(10-1+15,y+30, int(can2["width"])-10-15,y+30, fill="#00ffff")
            ...
            can2.create_text(30,y+15,text="New Playlist",font=("FreeMono",13),fill="#00ffff",anchor="w")
            ...
            #can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30, outline="#00ffff")

            can2.create_image(int(can2["width"])/2-100-15,y,image=circle3,anchor="nw")
            can2.create_image(int(can2["width"])/2+100-15,y,image=circle3,anchor="nw")

            can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30-1,fill="#00ffff",outline="#00ffff")
            ...
            can2.create_line(0,y, int(can2["width"])-3,y,fill="#003538")
            ...
            for pl in playlist:
                ...
                if scon==1:
                    ...
                    if current_playlist!=pl:
                        can2.create_line(0,y+50, int(can2["width"]),y+50,fill="#003538")
            ...
            if len(_playlist)==0:
                ...
                can2.create_text(int(can2["width"])/2,y+((450*h/680)-y)/2,text="No Record",font=("FreeMono",13),fill="#00ffff")
        ...
        can.create_rectangle(w/2-80,yv, w/2+80,yv+30-1,fill="#00ffff",outline="#00ffff")
        ...
        can.create_rectangle(w/2-80,yv+60, w/2+80,yv+30-1+60,fill="#00ffff",outline="#00ffff")
    ...
    if lst==1:
        ...
        if st==2 and playlist_st==0 and pl_st==0:
            ...
            #draw_round_rec(can,10,40, w-10,40+30,10,"#000000","#00ffff",0)
    ...
    if playlist_st==0 and st==2 and pl_st==0 :
        ...
        #can.create_text(10,h-20-60-20-27,text=current_playlist,font=("FreeMono",13),anchor="w",fill="#00ffff")


        #can.create_text(10,h-20-60-20-27-30,text=current_playlist,font=("FreeMono",13),anchor="w",fill="#00ffff")
    ...
    can.create_image(742,600, image=spider,anchor="n")    
...
def load_im():
    ...
    global circle2,circle3,expand,expand2,playlist4,web,web2,web3,web4,cockroach,spider
    ...
    web=ImageTk.PhotoImage(file="data/spiderweb.png")
    web2=ImageTk.PhotoImage(file="data/spiderweb2.png")
    web3=ImageTk.PhotoImage(file="data/spiderweb3.png")
    web4=ImageTk.PhotoImage(file="data/spiderweb4.png")
    cockroach=ImageTk.PhotoImage(file="data/cockroach.png")
    spider=ImageTk.PhotoImage(file="data/hanging-spider.png")
...
def load_():
    ...
    if st==4 and load_st==1:
        ...
        load=can.create_arc(w/2-20,493-20-40, w/2+20,493-20,outline="#00ffff",width=2,style=tk.ARC,start=load_ang,extent=270)
...
style.configure("My.Vertical.TScrollbar", gripcount=0, background="#00ffff",
...
style2.configure("My.Vertical.TScrollbar2", gripcount=0, background="#00ffff",
...
frame=tk.Frame(bg="#000000",width=w-20,height=(450*h/680))

can2=tk.Canvas(frame,bg="#000000",width=w-7-20,height=(450*h/680),relief="flat",highlightthickness=0,border=0,
...
can4.create_text(350/2,20,text="Playlists",font=("FreeMono",13),fill="#00ffff")
can4.create_line(0,38,350,38,fill="#00ffff")
...
search=tk.Entry(bg="#000000",fg="#00ffff",insertbackground="#00ffff",relief="flat",highlightthickness=0,border=0,width=86,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#000000",fg="#00ffff",insertbackground="#00ffff",relief="flat",highlightthickness=0,border=0,width=84,font=("FreeMono",13))
...
can_sort.create_text(125,15,text="Sort",font=("FreeMono",13),fill="#00ffff")


can_sort.create_line(0,30, 250,30,fill="#00ffff" )
...
for _ in a:
    ...
    can_sort.create_text(20,y+15,text=_,font=("FreeMono",13),fill="#00ffff",anchor="w")

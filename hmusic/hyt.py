...
im=Image.open("data_hyt/copy.png")
im=im.resize((25,25))
im.save("data_hyt/copy.png")


im=Image.open("data_hyt/cancel.png")
im=im.resize((25,25))
im.save("data_hyt/cancel.png")
"""
...
def load_im():
	...
	cancel=ImageTk.PhotoImage(file="data_hyt/cancel.png")
	copy=ImageTk.PhotoImage(file="data_hyt/copy.png")

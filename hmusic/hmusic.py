...
def add_playlist():
    ...
    cp2_im=create_polygon(*ar, fill="#ff1f83", alpha=0.25,can=can3)
        ...
        if cx-12.5<=e.x<=cx+12.5:
            if cy-12.5<=e.y<=cy+12.5:
                ...
                if sort_st==1:
                    ...
                    csv_im=create_polygon(*ar, fill="#ff1f83", alpha=0.25,can=can_sort)
...
def main():
    ...
    cp_im=create_polygon(*ar, fill="#ff1f83", alpha=0.25,can=can2)
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_rectangle(x-40+15+1,y+1, x+40-15+1,y+30-1-1, fill=col2,outline=col2)

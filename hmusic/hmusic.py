...
def main():
    ...
    frame["width"]=w-20-2
    frame["height"]=((h-122)-87-30)

    can2["width"]=w-7-20-2
    can2["height"]=((h-122)-87-30)
    ...
    if select_st==1:
        ...
        if len(songs2)==0:
            ...
            #can2.create_text((w-7)/2,((h-122)-87-30)/2,text="No Record!",font=("TkDefaultFont",12),fill=col1)
        ...
        if st==0:
            ...
            if len(songs)==0:
                ...
                #can2.create_text(int(can2["width"])/2,((h-122)-87-30)/2,text="No Record!",font=("TkDefaultFont",12),fill=col1)
            ...
            if playlist_st==0:
                ...
                if len(_playlist)==0:
                    ...
                    #can2.create_text(int(can2["width"])/2,y+(((h-122)-87-30)-y)/2,text="No Record",font=("TkDefaultFont",12),fill=col1)
...
def draw_can():
    ...
    _bg_=can.create_image(w-260,0,image=headphones,anchor="ne")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            if _search==1:
                ...
                can.create_oval(w-10-30,40+30-10-5-5, w-10,40+30+30-10-5-5,fill="#000000",outline="#000000")

                can.create_rectangle(10+15,40+30-10-5-5, w-10-15,40+30+30-10-5-5,fill="#000000",outline="#000000")
        ...
        if lst==0:
            ...
            if not current_playing=="":
                ...
                if not _lyric_=="":
                    ...
                    _bg3_=can_lyrics.create_image(w-260-10,-(50)+can_lyrics.canvasy(0),image=headphones,anchor="ne")
                    ...
                    can_lyrics["height"]=(h-122+5-30-50/2+(50-30)/2)-50
...
def _on_mousewheel(e):
    ...
    if add_st==0 and lst==1:
        ...
        if int(can2["scrollregion"].split(" ")[-1])>((h-122)-87-30):
...
frame=tk.Frame(bg="#000000",width=w-20-2,height=((h-122)-87-30))

can2=tk.Canvas(frame,bg="#000000",width=w-7-20-2,height=((h-122)-87-30),relief="flat",highlightthickness=0,border=0)
can2["scrollregion"]=(0,0,int(can2["width"]),int(can2["height"]))
...
move_to_playing()
if playlist_st==0:
    pass#can2["scrollregion"]=(0,0,w-7,((h-122)-87-30))

...
im=Image.open("data/red/circle.png")
im=im.resize((4,4))
im.save("data/red/circle7.png")




im=Image.open("data/mint/circle.png")
im=im.resize((4,4))
im.save("data/mint/circle7.png")





im=Image.open("data/cyan/circle.png")
im=im.resize((4,4))
im.save("data/cyan/circle7.png")
...
def convert_folder_to_audio():
    ...
    if convert==1:
        ...
        if st==4:
            ...
            load=can.create_text(w/2,493-20-40-30,text="...",font=("TkDefaultFont",25),fill=col1)
            ...
            for i in all_items:
                ...
                try:
                    ...
                    if st==4:
                        ...
                        load=can.create_text(10,h-20-60-60,text=i,font=("TkDefaultFont",12),fill=col1,anchor="w")
                    main()
        ...
        if st==4:
            ...
            load=can.create_text(w/2,493-20-40-30+100,text="Done!",font=("TkDefaultFont",12),fill="#000000")
        convert=0
        update_waves()
...
def can_b1(e):
    ...
    if theme_st==1:
        ...
        cx,cy=x+5+30+10+30+10+15,y+5+15
...
def main():
    ...
    if select_st==1:
        ...
        if len(songs2)==0:
            ...
            #can2.create_text((w-7)/2,((h-133)-97-20)/2,text="No Record!",font=("TkDefaultFont",12),fill=col1)
        ...
        if st==0:
            ...
            if len(songs)==0:
                ...
                #can2.create_text(int(can2["width"])/2,((h-133)-97-20)/2,text="No Record!",font=("TkDefaultFont",12),fill=col1)
            ...
            if playlist_st==0:
                ...
                if len(_playlist)==0:
                    ...
                    #can2.create_text(int(can2["width"])/2,y+(((h-133)-97-20)-y)/2,text="No Record",font=("TkDefaultFont",12),fill=col1)
...
def draw_can():
        ...
        if lyric_st==0:
            ...
            try:
                ...
                if not music_details[current_playing][2]=="":
                    ...
                    can.create_image(x+40+5,y+15-2, image=circle7,anchor="nw")
            except:
                pass
    ...
    if lst==1:
        ...
        if st==4:
            ...
            if select_st==1:
                draw_round_rec(can,10,97,w-10,h-133+75,10,"#000000",col1,3,1)
            else:

                draw_round_rec(can,10,97,w-10,h-133,10,"#000000",col1,3,1)
        ...
        if playlist_st==0 and st==2:
            ...
            can.create_image((w-420)/2,55+(((h-133)-55)-420)/2,image=note,anchor="nw")
    ...
    if theme_st==1:
        ...
        draw_round_rec(can,x,y, x+130-10,y+40,20,col2,col2,0)


        can.create_image(x+5,y+5,image=red,anchor="nw")
        can.create_image(x+5+30+10,y+5,image=mint,anchor="nw")
        can.create_image(x+5+30+10+30+10,y+5,image=cyan,anchor="nw")
    ...
    if st==4:
        ...
        can.create_image((w-420)/2,55+((h-55)-420)/2,image=note,anchor="nw")
        frame.place_forget()
    ...
    can.create_text(w/4,h-15,text="H34 ©",font=("TkDefaultFont",12),anchor="c",fill=col1)
        ...
        if lst==0:
            ...
            if not current_playing=="":
                ...
                if not _lyric_=="":
                    ...
                    can_lyrics["height"]=(h-145-30-4)-55
                    ...
                    can.create_text(w/2,55+((h-133)-55)/2,text="Nothing to show!",fill=col1,font=("TkDefaultFont",12))

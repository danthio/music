...
def add_playlist():
    ...
    for p in playlist:
        ...
        #can3.create_line(0,y+50,450-7,y+50,fill="#0f0e1b")
            ...
            if cy-12.5<=e.y<=cy+12.5:
                ...
                if sort_st==1:
                    ...
                    for _ in sa:
                        ...
                        #can_sort.create_line(0,y+30,250,y+30,fill="#0f0e1b")
...
def main():
    ...
    #cp_im=create_polygon(*ar, fill="#00ffff", alpha=0.6,can=can2)
    ...
    if select_st==1:
        ...
        if len(songs2)==0:
            ...
            style.configure("My.Vertical.TScrollbar", gripcount=0, background="#0f0e1b",
                            troughcolor="#0f0e1b", borderwidth=0, bordercolor="#0f0e1b",
                            lightcolor="#0f0e1b",relief="flat", darkcolor="#0f0e1b",
                            arrowsize=6)
        ...
        #hex(can,-30,-30,w+60,h+60,30,"#390200","#0f0e1b")
        ...
        #can2.create_image(-10,can2.canvasy(-(80-30+40))+h,image=wallpaper,anchor="nw")
        #create_rectangle(can2,0, int(can2.canvasy(0))-h, int(can2["width"]), int(can2.canvasy(int(can2["height"])))+h, fill='#0f0e1b', alpha=.65)
        ...
        if st==0:
            ...
            if playlist_st==0:
                ...
                create_polygon(*ar, fill="#00ffff", alpha=0.2,can=can2)

                if _npl==1:

                    can2.create_oval(10,y, 10+30,y+30, fill="#0f0e1b",outline="#0f0e1b")
                    can2.create_oval((int(can2["width"])-sb_sz-1)-10-30,y, (int(can2["width"])-sb_sz-1)-10,y+30,fill="#0f0e1b",outline="#0f0e1b")

                    can2.create_rectangle(10+15,y, (int(can2["width"])-sb_sz-1)-10-15,y+30,fill="#0f0e1b",outline="#0f0e1b")
                ...
                can2.create_text((int(can2["width"])-sb_sz-1)/2,y+15,text="Create New Playlist",font=("FreeMono",12),fill="#0f0e1b")
        ...
        """
        if y<=((h-121)-80-10):
            hex(can2,-30,-30,w+60,int(can2["height"])+60,30,"#390200","#0f0e1b")


        else:

            hex(can2,-30,-30,w+60,y+60,30,"#390200","#0f0e1b")
...
def draw_can():
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",12),fill="#0f0e1b")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            create_polygon(*ar, fill="#00ffff", alpha=0.2,can=can)
            
            if _search==1:

                can.create_oval(10,40+30-10-5-5, 10+30,40+30+30-10-5-5,fill="#0f0e1b",outline="#0f0e1b")
                can.create_oval(w-10-30-1,40+30-10-5-5, w-10-1,40+30+30-10-5-5,fill="#0f0e1b",outline="#0f0e1b")

                can.create_rectangle(10+15,40+30-10-5-5, w-10-15-1,40+30+30-10-5-5,fill="#0f0e1b",outline="#0f0e1b")
        ...
        if playlist_st==0 and st==2 and pl_st==0 and current_playing=="":
            ...
            try:
                ...
                if songs_status[1]!="":
                        ...
                        can.create_text(10+15+30,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=current_playlist_,font=("FreeMono",12,),anchor="w",fill="#0f0e1b")
    ...
    if st==4:
        ...
        can.create_text(w/2,yv+15,text="Add Folder",fill="#0f0e1b",font=("FreeMono",12))
        ...
        can.create_text(w/2,yv+15+60,text="Add Audio File",fill="#0f0e1b",font=("FreeMono",12))
...
can=tk.Canvas(width=w,height=h,bg="#0f0e1b",relief="flat",highlightthickness=0,border=0,cursor="arrow")
...
frame=tk.Frame(bg="#0f0e1b",width=w-20,height=((h-121)-80-10))
...
can2=tk.Canvas(frame,bg="#0f0e1b",width=w-20,height=((h-121)-80-10),relief="flat",highlightthickness=0,border=0)
can2["scrollregion"]=(0,0,int(can2["width"]),int(can2["height"]))
...
frame2=tk.Frame(bg="#0f0e1b",width=350+100,height=250)

can4=tk.Canvas(frame2,bg="#0f0e1b",width=350+100,height=40,relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,300-7,250))
can4.pack(side=tk.TOP)



frame3=tk.Frame(frame2,bg="#0f0e1b",width=350+100,height=250-40)
...
psb2_h=0
sb2_st=0
can3=tk.Canvas(frame3,bg="#0f0e1b",width=350+100,height=250-40,relief="flat",highlightthickness=0,border=0,
...
can6=tk.Canvas(frame2,bg="#0f0e1b",width=350+100,height=17,relief="flat",highlightthickness=0,border=0)
...
search=tk.Entry(bg="#0f0e1b",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=115,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#0f0e1b",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=112,font=("FreeMono",13))
...
sort_st=0
_sort=0
can_sort=tk.Canvas(bg="#0f0e1b",width=250,height=160,relief="flat",highlightthickness=0,border=0)
...
can_lyrics=tk.Canvas(bg="#0f0e1b",relief="flat",highlightthickness=0,border=0)

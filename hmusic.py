    ...
    if play_st==1:
        ...
        try:
            ...
            try:
                ...
                if lst==0 and st!=4 and lyric_st==0:
...
def convert_folder_to_audio():
    ...
    if convert==1:
        ...
        if st==4:
            ...
            load2=can.create_oval(w/2-50,493-20-40-30-15, w/2-50+30,493-20-40-30+15,fill=col1,outline=col1)
            load3=can.create_oval(w/2+50-30,493-20-40-30-15, w/2+50,493-20-40-30+15,fill=col1,outline=col1)
            load4=can.create_rectangle(w/2-50+15,493-20-40-30-15, w/2+50-15,493-20-40-30+15,fill=col1,outline=col1)
...
def save():
    ...
    global st,current_playing,current_playlist,playlist_st,lst,sort_val,shuff,loop,theme,save_,shuffle_ar
    ...
    try:
        ...
        data={"save":[st,current_playing,current_playlist,playlist_st,lst,sort_val,shuff,loop,theme,shuffle_ar]}
...
def can_b1(e):
    ...
    if theme_st==1:
        ...
        cx,cy=w-80-130/2+10+15,5+30+5+15
        ...
        cx,cy=w-80-130/2+10+30+10+15,5+30+5+15
        ...
        cx,cy=w-80-130/2+10+30+10+30+10+15,5+30+5+15
    ...
    if lyric_st==1:
        ...
        if r<=12.5:
            ...
            if not current_playing=="":
                update_details(current_playing,3,_lyric)
...
def check_volume():
    ...
    if volume.GetMasterVolumeLevelScalar()!=current_volume:
        ...
        vol3=can.create_text(w-10-100+50,h-20-30+5+20+10-2,text=str(int(current_volume*100))+" %",fill=col1,font=("FreeMono",13))
    ...
    if st==0:
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if song==current_playing:
                    can2.create_rectangle(w-7-10-30-20-30-20-30-10-20,y+5, w-7-30,y+45,fill=col1,outline=col1)
                    can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                else:
                ...
                if not song==current_playing:
                    ...
                    can2.create_line(0,y+50,w-10,y+50,fill=col2)
        ...
        if len(songs)==0:
            ...
            can2.create_text((w-7)/2,(450*h/680)/2,text="No Record!",font=("FreeMono",13),fill=col1)
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if music_details[song][0]==1:
                    ...
                    can2.create_text(10+30,y+25,text=song,font=("FreeMono",13),fill=col,anchor="w")
                    if song==current_playing:
                        can2.create_rectangle(w-7-10-30-20-30-20-30-10-20,y+5, w-7-30-20,y+45,fill=col1,outline=col1)
                        can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                    else:
                    ...
                    if not song==current_playing:
                        ...
                        can2.create_line(0,y+50,w-10-20,y+50,fill=col2)
        ...
        if playlist_st==0:
            ...
            if len(_playlist)==0:
                ...
                can2.create_text(int(can2["width"])/2,y+((450*h/680)-y)/2,text="No Record",font=("FreeMono",13),fill=col1)
...
def draw_can():
    ...
    if lst==0:
        ...
        if lyric_st==0:
            ...
            can.create_image(x+40+10,y+2.5,image=paste,anchor="nw")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            if root.wm_attributes("-fullscreen")==0:
                ...
                draw_round_rec(can,10-2,80-10-30+40,w-10,80-30+40+(450*h/680)+10,15,"#000000",col1,0)
            elif root.wm_attributes("-fullscreen")==1:
                draw_round_rec(can,10-2,80-10-30+40,w-10,80-30+40+(450*h/680)+10+30,15,"#000000",col1,0)
    ...
    can.create_image(w-80,5, image=theme_,anchor="nw")
    ...
    if playlist_st==0 and st==2 and pl_st==0 :
        ...
        if not current_playing=="":
            ...
            can.create_text(w-10,h-20-60-20-27+3+10+3+2,text=t,font=("FreeMono",13),anchor="e",fill=col1)
    ...
    if theme_st==1:
        ...
        can.create_oval(w-80-130/2,5+30, w-80-130/2+40,5+30+40,fill=col2,outline=col2)
        can.create_oval(w-80-130/2+130-40,5+30, w-80-130/2+130,5+30+40,fill=col2,outline=col2)
        can.create_rectangle(w-80-130/2+15,5+30, w-80-130/2+130-15,5+30+40,fill=col2,outline=col2)


        can.create_image(w-80-130/2+10,5+30+5,image=red,anchor="nw")
        can.create_image(w-80-130/2+10+30+10,5+30+5,image=mint,anchor="nw")
        can.create_image(w-80-130/2+10+30+10+30+10,5+30+5,image=cyan,anchor="nw")
    ...
    if lst==0:
        ...
        if not current_playing=="":
            ...
            if not _lyric_=="":
                ...
                text.place(in_=root,x=(w-(790-111))/2,y=75-10)

                draw_round_rec(can,126,64+3-10 ,820,520-3-10,15,"#000000",col1,0)
                ...
                can.create_text(w/2,71+(513-71)/2,text="Nothing to show!",fill=col1,font=("FreeMono",13))
                text.place_forget()
...
def load_im():
    ...
    global circle2,circle3,circle4,expand,expand2,playlist4,web,web2,web3,web4,cockroach,spider
    ...
    web=ImageTk.PhotoImage(file="data/"+theme+"/spiderweb.png")
    web2=ImageTk.PhotoImage(file="data/"+theme+"/spiderweb2.png")
    web3=ImageTk.PhotoImage(file="data/"+theme+"/spiderweb3.png")
    web4=ImageTk.PhotoImage(file="data/"+theme+"/spiderweb4.png")
    cockroach=ImageTk.PhotoImage(file="data/"+theme+"/cockroach.png")
    spider=ImageTk.PhotoImage(file="data/"+theme+"/hanging-spider.png")
...
st,current_playing,current_playlist,playlist_st,lst,sort_val,shuff,loop,theme,shuffle_ar=data["save"]

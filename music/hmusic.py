        ...
        try:
            ...
            try:
                ...
                if lst==0 and st!=4:
                    ...
                    sig_=can.create_line(sig2,fill="red")
            except:
                pass
...
def convert_folder_to_audio():
    ...
    if convert==1:
        ...
        if st==4:
            ...
            load=can.create_text(w/2,493-20-40-30,text="...",font=("FreeMono",25),fill="red")
        ...
        if st==4:
            ...
            load2=can.create_oval(w/2-50,493-20-40-30-15, w/2-50+30,493-20-40-30+15,fill="red",outline="red")
            load3=can.create_oval(w/2+50-30,493-20-40-30-15, w/2+50,493-20-40-30+15,fill="red",outline="red")
            load4=can.create_rectangle(w/2-50+15,493-20-40-30-15, w/2+50-15,493-20-40-30+15,fill="red",outline="red")
...
def prog():
    ...
    ctime=can.create_text(10,h-20-60-20+20+10,text=tt,font=("FreeMono",13),fill="red",anchor="w")
    ...
    prog1=can.create_line(10,h-20-60-20+10, x_+10,h-20-60-20+10,fill="red",width=4)
    prog2=can.create_oval(x_+10-5,h-20-60-20-5+10, x_+10+5,h-20-60-20+5+10,fill="#000000",outline="red")
        ...
        if r<=15:
                ...
                if add_st==1:
                    ...
                    for p in playlist:
                        ...
                        can3.create_text(10+30+10,y+25,text=p,font=("FreeMono",13),anchor="w",fill="red")
...
def can_b1(e):
    ...
    if 10<=e.x<=w-10-5-30:
        if 40<=e.y<=40+30:
            ...
            can.create_arc(10,40, 10+30,40+30, style=tk.ARC,start=90,extent=180,outline="red")
            can.create_arc(w-10-30,40, w-10,40+30, style=tk.ARC,start=270,extent=180,outline="red")

            can.create_line(10+15,40, w-10-15,40, fill="red")
            can.create_line(10-1+15,40+30, w-10-15,40+30, fill="red")
    ...
    if w-10-100-10<=e.x<=w-10+10:
        if h-20-30+5-10+10<=e.y<=h-20-30+5+10+10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5+10 ,w-10-100+current_volume*r,h-20-30+5+10,fill="red",width=3)
            vol2=can.create_oval(w-10-100+current_volume*r-5,h-20-30+5-5+10, w-10-100+current_volume*r+5,h-20-30+5+5+10,fill="#000000",outline="red")

            vol3=can.create_text(w-10-100+50,h-20-30+5+20+10-2,text=str(int(current_volume*100))+" %",fill="red",font=("FreeMono",13))
    ...
    if st==4:
        ...
        #can.create_rectangle(w/2-150,yv, w/2+150,yv+30, fill="red")
...
def main():
    ...
    for l in range(len(label)):
        ...
        if l==st:
            ...
            can.create_rectangle(x-60+15,5, x+60-15,35-1, fill="red",outline="red")
    ...
    if st==0:
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                if song==current_playing:
                    ...
                    can2.create_rectangle(25+5,y, int(can2["width"])-25,y+50-1,fill="red",outline="red")
                ...
                if song==current_playing:
                    can2.create_rectangle(w-7-10-30-20-30-20-30-10,y+5, w-7-30,y+45,fill="red",outline="red")
                    can2.create_image(int(can2["width"])-50,y,image=circle2,anchor="nw")
                else:
        ...
        if len(songs)==0:
            ...
            can2.create_text((w-7)/2,(450*h/680)/2,text="No Record!",font=("FreeMono",13),fill="red")
        ...
        if playlist_st==0:
            ...
            can.create_text(30+20+5,40+15,text="Search",font=("FreeMono",13),fill="red",anchor="w")
            ...
            #can.create_line(10,70,w-10,70,fill="red")
            #can.create_line(10,80+h-240+10,w-10,80+h-240+10,fill="red")
            ...
            can2.create_arc(10,y, 10+30,y+30, style=tk.ARC,start=90,extent=180,outline="red")
            can2.create_arc(int(can2["width"])-10-30,y, int(can2["width"])-10,y+30, style=tk.ARC,start=270,extent=180,outline="red")

            can2.create_line(10+15,y, int(can2["width"])-10-15,y, fill="red")
            can2.create_line(10-1+15,y+30, int(can2["width"])-10-15,y+30, fill="red")
            ...
            can2.create_text(30,y+15,text="New Playlist",font=("FreeMono",13),fill="red",anchor="w")
            ...
            #can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30, outline="red")

            can2.create_image(int(can2["width"])/2-100-15,y,image=circle3,anchor="nw")
            can2.create_image(int(can2["width"])/2+100-15,y,image=circle3,anchor="nw")

            can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30-1,fill="red",outline="red")
            ...
            can2.create_line(5,y, int(can2["width"]),y,fill="#610400")
            ...
            if len(_playlist)==0:
                current_playing=""
                can2["width"]=w-7+30
                can2.create_text(int(can2["width"])/2,y+((450*h/680)-y)/2,text="No Record",font=("FreeMono",13),fill="red")
        ...
        can.create_rectangle(w/2-80,yv, w/2+80,yv+30-1,fill="red",outline="red")
        ...
        can.create_rectangle(w/2-80,yv+60, w/2+80,yv+30-1+60,fill="red",outline="red")
    ...
    if lst==1:
        ...
        if st==2 and playlist_st==0 and pl_st==0:
            ...
            #draw_round_rec(can,10,40, w-10,40+30,10,"#000000","red",0)
    ...
    if playlist_st==0 and st==2 and pl_st==0 :
        ...
        if len(current_playlist)>0:
            ...
            can.create_rectangle(10+15,h-20-60-20-27-15+3+10, 10+15+length_in_pixels+30,h-20-60-20-27+14+3+10,fill="red",outline="red")
            ...
            can.create_text(10+15+length_in_pixels+15+10+30,h-20-60-20-27+3+10,text=current_playing,font=("FreeMono",13),anchor="w",fill="red")
        else:
            can.create_text(10,h-20-60-20-27+3+10,text=current_playing,font=("FreeMono",13),anchor="w",fill="red")
        ...
        if not current_playing=="":
            ...
            can.create_text(w-10,h-20-60-20-27+3+10,text=t,font=("FreeMono",13),anchor="e",fill="red")



    can.create_line(10,h-20-60-20+10,w-10,h-20-60-20+10,fill="#610400",width=4)
    ...
    if st==2 and playlist_st==0:
        ...
        can.create_text(w-10,h-20-60-20+20+10,text=tot_tm,font=("FreeMono",13),anchor="e",fill="red")
    ...
    can.create_line(w-10-100,h-20-30+5+10, w-10,h-20-30+5+10,fill="#610400",width=3)
...
def load_():
    ...
    if st==4 and load_st==1:
        ...
        load=can.create_arc(w/2-20,493-20-40, w/2+20,493-20,outline="red",width=2,style=tk.ARC,start=load_ang,extent=270)
...
style.configure("My.Vertical.TScrollbar", gripcount=0, background="red",
...
style2.configure("My.Vertical.TScrollbar2", gripcount=0, background="red",
...
can4.create_text(350/2,20,text="Playlists",font=("FreeMono",13),fill="red")
can4.create_line(0,38,350,38,fill="red")
...
search=tk.Entry(bg="#000000",fg="red",insertbackground="red",relief="flat",highlightthickness=0,border=0,width=86,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#000000",fg="red",insertbackground="red",relief="flat",highlightthickness=0,border=0,width=84,font=("FreeMono",13))
...
can_sort.create_text(125,15,text="Sort",font=("FreeMono",13),fill="red")


can_sort.create_line(0,30, 250,30,fill="red" )
...
for _ in a:
    ...
    can_sort.create_text(20,y+15,text=_,font=("FreeMono",13),fill="red",anchor="w")

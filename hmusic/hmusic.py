...
def draw_can(con=0):
    ...
    if vid_st==0:
        ...
        can.create_image(0,h-20,image=b_g1_,anchor="nw")
    ...
    cnxt_v2=can.create_text(cnxt_x1+l,h-15+3,text="Up Next !    ",font=("FreeMono",13),anchor="w",fill=_theme[0])
...
def load_im():
    ...
    b_g1_=ImageTk.PhotoImage(Image.new("RGBA",(w,20),(0,0,0,150)))

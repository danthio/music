...
def prog():
    ...
    ctime=can.create_text(10,h-20-60-20+20,text=tt,font=("FreeMono",13),fill="red",anchor="w")
    ...
    prog1=can.create_line(10,h-20-60-20, x_+10,h-20-60-20,fill="red",width=4)
    prog2=can.create_oval(x_+10-5,h-20-60-20-5, x_+10+5,h-20-60-20+5,fill="#000000",outline="red")
    ...
    if st==2 and playlist_st==0:
        ...
        if 10<=e.x<=int(can2["width"])-10:
            if 5<=e.y<=35:
                ...
                can2["scrollregion"]=(0,0,w-7,(440*h/680))
                npl.delete(0,tk.END)
                _npl=1
...
def can_b1(e):
    ...
    if w-10-100-10<=e.x<=w-10+10:
        if h-20-30+5-10<=e.y<=h-20-30+5+10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5 ,w-10-100+current_volume*r,h-20-30+5,fill="red",width=2)
            vol2=can.create_oval(w-10-100+current_volume*r-5,h-20-30+5-5, w-10-100+current_volume*r+5,h-20-30+5+5,fill="#000000",outline="red")

            vol3=can.create_text(w-10-100+50,h-20-30+5+20,text=str(int(current_volume*100))+" %",fill="red",font=("FreeMono",13))
    ...
    if r<=15:
        ...
        if add_st==0:
            ...
            for p in playlist:
                ...
                can3.create_image(10,y+10,image=playlist2,anchor="nw")
                can3.create_text(10+30+10,y+25,text=p,font=("FreeMono",13),anchor="w",fill="red")
                can3.create_line(0,y+50,350-7,y+50,fill="red")
...
def check_volume():
    ...
    if volume.GetMasterVolumeLevelScalar()!=current_volume:
        ...
        vol1=can.create_line(w-10-100,h-20-30+5 ,w-10-100+current_volume*r,h-20-30+5,fill="red",width=3)
        vol2=can.create_oval(w-10-100+current_volume*r-5,h-20-30+5-5, w-10-100+current_volume*r+5,h-20-30+5+5,fill="#000000",outline="red")
...
def main():
    ...
    if lst==1 and st!=4:
        ...
        can.create_line(5,80-30+40+5+int(can2["height"]),w-7,80-30+40+5+int(can2["height"]),fill="red")
    ...
    if st==0:
        ...
        for song in all_songs:
            ...
            if not song.lower().find(search_var.lower())==-1:
                ...
                if song==current_playing:
                    ...
                    can2.create_rectangle(25,y, int(can2["width"])-25,y+50-1,fill="red",outline="red")
        ...
        if len(songs)==0:
            current_playing=""
            can2.create_text((w-7)/2,(440*h/680)/2,text="No Record!",font=("FreeMono",13),fill="red")
    elif st==1:
        songs=[]
        ...
        if playlist_st==0:
            ...
            if len(_playlist)==0:
                current_playing=""
                can2.create_text(int(can2["width"])/2,y+((440*h/680)-y)/2,text="No Record",font=("FreeMono",13),fill="red")
        ...
        can.create_rectangle(w/2-150,yv, w/2+150,yv+30-1,fill="red",outline="red")
        ...
        can.create_rectangle(w/2-150,yv+60, w/2+150,yv+30-1+60,fill="red",outline="red")
    ...
    if playlist_st==0 and st==2 and pl_st==0 :
        ...
        if len(current_playlist)>0:
            ...
            can.create_image(10,h-20-60-20-27-15+3, image=circle3,anchor="nw")
            can.create_image(10+15+length_in_pixels-15,h-20-60-20-27-15+3, image=circle3,anchor="nw")
            can.create_rectangle(10+15,h-20-60-20-27-15+3, 10+15+length_in_pixels,h-20-60-20-27+14+3,fill="red",outline="red")

            can.create_text(10+15,h-20-60-20-27+3,text=current_playlist,font=("FreeMono",13,),anchor="w",fill="#000000")
                  
            can.create_text(10+15+length_in_pixels+15+10,h-20-60-20-27+3,text=current_playing,font=("FreeMono",13),anchor="w",fill="red")
        else:
            can.create_text(10,h-20-60-20-27+3,text=current_playing,font=("FreeMono",13),anchor="w",fill="red")
        ...
        if not current_playing=="":
            ...
            can.create_rectangle(w-10-l-10, h-20-60-20-27+3-13, w, h-20-60-20-27+3+13,fill="#000000",outline="#000000")

            can.create_text(w-10,h-20-60-20-27+3,text=t,font=("FreeMono",13),anchor="e",fill="red")
    ...
    if st==2 and playlist_st==0:
        ...
        can.create_text(w-10,h-20-60-20+20,text=tot_tm,font=("FreeMono",13),anchor="e",fill="red")
    ...
    can.create_line(w-10-100,h-20-30+5, w-10,h-20-30+5,fill="#610400",width=3)
...
frame=tk.Frame(bg="#000000",width=w,height=(440*h/680))

can2=tk.Canvas(frame,bg="#000000",width=w-7,height=(440*h/680),relief="flat",highlightthickness=0,border=0,

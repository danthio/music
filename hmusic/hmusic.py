        ...
        try:
            ...
            if cap is not None and cap.isOpened() and not paused:
                ...
                if ret:
                    ...
                    vid_canvas.create_polygon(ar,fill="#000f10",outline="#000f10")
...
def add_playlist():
    ...
    for p in playlist:
        ...
        #can3.create_line(0,y+50,450-7,y+50,fill="#000f10")
        ...
        if cx-12.5<=e.x<=cx+12.5:
            if cy-12.5<=e.y<=cy+12.5:
                ...
                if sort_st==1:
                    ...
                    draw_round_rec(can_sort,2,2, 250-2,160-2,15,"#000f10",col1,0)
                    ...
                    for _ in sa:
                        ...
                        #can_sort.create_line(0,y+30,250,y+30,fill="#000f10")
...
def main():
    ...
    #create_rectangle(can,0, 0, w, h, fill='#000f10', alpha=.65)
    ...
    if select_st==1:
        ...
        if len(songs2)==0:
            ...
            style.configure("My.Vertical.TScrollbar", gripcount=0, background="#000f10",
                            troughcolor="#000f10", borderwidth=0, bordercolor="#000f10",
                            lightcolor="#000f10",relief="flat", darkcolor="#000f10",
                            arrowsize=6)
        ...
        #hex(can,-30,-30,w+60,h+60,30,"#390200","#000f10")
        ...
        #can2.create_image(-10,can2.canvasy(-(80-30+40))+h,image=wallpaper,anchor="nw")
        #create_rectangle(can2,0, int(can2.canvasy(0))-h, int(can2["width"]), int(can2.canvasy(int(can2["height"])))+h, fill='#000f10', alpha=.65)
        ...
        if st==0:
            ...
            for song in all_songs:
                ...
                if scon==1:
                    ...
                    if song==current_playing:
                        ...
                        can2.create_line(2,y, int(can2["width"]),y,fill="#000f10")
            ...
            if playlist_st==0:
                ...
                if _search==1:
                    ...
                    can.create_oval(10,40, 10+30,40+30,fill="#000f10",outline="#000f10")
                    can.create_oval(w-10-30,40, w-10,40+30,fill="#000f10",outline="#000f10")

                    can.create_rectangle(10+15,40, w-10-15,40+30,fill="#000f10",outline="#000f10")
                ...
                if _npl==1:
                    ...
                    can2.create_oval(10,y, 10+30,y+30, fill="#000f10",outline="#000f10")
                    can2.create_oval(int(can2["width"])-10-30,y, int(can2["width"])-10,y+30,fill="#000f10",outline="#000f10")

                    can2.create_rectangle(10+15,y, int(can2["width"])-10-15,y+30,fill="#000f10",outline="#000f10")
                ...
                can2.create_text(int(can2["width"])/2,y+15,text="Create New Playlist",font=("TkDefaultFont",12),fill="#000f10")
        ...
        """
        if y<=((h-121)-80-10):
            hex(can2,-30,-30,w+60,int(can2["height"])+60,30,"#390200","#000f10")


        else:

            hex(can2,-30,-30,w+60,y+60,30,"#390200","#000f10")
...
def draw_can():
    ...
    #hex(can,-40,-40,w+40,h+40,40,"#000f10","#000f10")
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_text(x,y+15,text="Lyrics",font=("TkDefaultFont",12),fill="#000f10")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            if _search==1:
                ...
                can.create_oval(10,40+30-10-5-5, 10+30,40+30+30-10-5-5,fill="#000f10",outline="#000f10")
                can.create_oval(w-10-30-1,40+30-10-5-5, w-10-1,40+30+30-10-5-5,fill="#000f10",outline="#000f10")

                can.create_rectangle(10+15,40+30-10-5-5, w-10-15-1,40+30+30-10-5-5,fill="#000f10",outline="#000f10")
            ...
            #draw_round_rec(can,10,40, w-10,40+30,10,"#000f10",col1,0)
        ...
        if playlist_st==0 and st==2 and pl_st==0 and current_playing=="":
            ...
            try:
                ...
                if songs_status[1]!="":
                        ...
                        can.create_text(10+15+30,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=current_playlist_,font=("TkDefaultFont",12,),anchor="w",fill="#000f10")
            ...
            if not current_playing=="":
                    ...
                    can.create_rectangle(w-10-26-5-l-10, h-20-60-20-27-15+3+10+3+2+2-3+15-13, w, h-20-60-20-27-15+3+10+3+2+2-3+15+13,fill="#000f10",outline="#000f10")
    ...
    if st==4:
        ...
        #draw_polygon(can,7,0,w/2,50+(((h-121)-50)-420)/2+210,210,col2,10,2,"#000f10",10)
        frame.place_forget()
        ...
        can.create_text(w/2,yv+15,text="Add Folder",fill="#000f10",font=("TkDefaultFont",12))
        ...
        can.create_text(w/2,yv+15+60,text="Add Audio File",fill="#000f10",font=("TkDefaultFont",12))
        ...
        if lst==0:
            ...
            if not current_playing=="":
                ...
                if not _lyric_=="":
                    ...
                    #draw_round_rec(can,0,h-145-30-5-450-10 ,w,h-145-30-5,10,"#000f10","#000f10",0)
...
can=tk.Canvas(width=w,height=h,bg="#000f10",relief="flat",highlightthickness=0,border=0,cursor="arrow")
...
frame=tk.Frame(bg="#000f10",width=w-20,height=((h-121)-80-10))

can2=tk.Canvas(frame,bg="#000f10",width=w-20,height=((h-121)-80-10),relief="flat",highlightthickness=0,border=0)
can2["scrollregion"]=(0,0,int(can2["width"]),int(can2["height"]))
...
frame2=tk.Frame(bg="#000f10",width=350+100,height=250)

can4=tk.Canvas(frame2,bg="#000f10",width=350+100,height=40,relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,300-7,250))
can4.pack(side=tk.TOP)



frame3=tk.Frame(frame2,bg="#000f10",width=350+100,height=250-40)

can3=tk.Canvas(frame3,bg="#000f10",width=350+100-5-2-1,height=250-40,relief="flat",highlightthickness=0,border=0,
...
can5=tk.Canvas(frame3,bg="#000f10",width=2,height=250-40,relief="flat",highlightthickness=0,border=0)
...
can6=tk.Canvas(frame2,bg="#000f10",width=350+100,height=17,relief="flat",highlightthickness=0,border=0)
...
search=tk.Entry(bg="#000f10",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=115,font=("TkDefaultFont",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#000f10",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=112,font=("TkDefaultFont",13))
...
sort_st=0
_sort=0
can_sort=tk.Canvas(bg="#000f10",width=250,height=160,relief="flat",highlightthickness=0,border=0)
...
can_lyrics=tk.Canvas(bg="#000f10",relief="flat",highlightthickness=0,border=0)



vid_canvas = tk.Canvas(relief="flat",highlightthickness=0,border=0)
vid_canvas["bg"]="#000f10"

    ...
    if st==2 and playlist_st==0:
        ...
        if 10<=e.x<=int(can2["width"])-10:
            if 5<=e.y<=35:
                ...
                npl.delete(0,tk.END)
                _npl=1
                npl.place(in_=root,x=10+15+10,y=90+15-5-1)
                npl.focus_set()
                main()
...
def main():
    ...
    #_bg2_=can2.create_image(-11,-(90+15)+can2.canvasy(0),image=headphones,anchor="nw")
...
def draw_can():
    ...
    #_bg_=can.create_image(0,0,image=headphones,anchor="nw")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            can.create_line(10,89-2,w-10,89-2,fill=col1)
            can.create_line(10,90+int(can2["height"]),w-10,90+int(can2["height"]),fill=col1)

            frame.place(in_=root,x=10,y=90-1)
        ...
        if lst==0:
            ...
            if not current_playing=="":
                ...
                if not _lyric_=="":
                    ...
                    #_bg3_=can_lyrics.create_image(-10,-(50)+can_lyrics.canvasy(0),image=headphones,anchor="nw")
...
def load_im():
    ...
    note=ImageTk.PhotoImage(file="data/musical_note3.png")
...
def move_bg():
    ...
    try:
        ...
        if not can2_y==can2.canvasy(0):
            ...
            can2.coords(_bg2_,-11,-(90+15)+can2.canvasy(0))
...
can3=tk.Canvas(frame3,bg="#000000",width=350+100-5-2,height=250-40,relief="flat",highlightthickness=0,border=0,

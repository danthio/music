...
def convert_folder_to_audio(input_folder, ffmpeg_path=None, sample_rate=44100, channels=2, bitrate="192k"):
    ...
    global can,load,load2,load3,load4,w
    ...
    load=can.create_text(w/2,493-20-40-30,text="Done!",font=("FreeMono",13),fill="#111111")
...
def prog():
    ...
    prog2=can.create_oval(x_+10-5,h-20-60-20-5, x_+10+5,h-20-60-20+5,fill="#111111",outline="#32fca7")
        ...
        if r<=15:
                ...
                if add_st==1:
                    ...
                    for p in playlist:
                        ...
                        can3.create_line(0,y+50,350-7,y+50,fill="#111111")
...
def can_b1(e):
    ...
    if w-10-100-10<=e.x<=w-10+10:
        if h-20-30+5-10<=e.y<=h-20-30+5+10:
            ...
            vol2=can.create_oval(w-10-100+current_volume*r-5,h-20-30+5-5, w-10-100+current_volume*r+5,h-20-30+5+5,fill="#111111",outline="#32fca7")
...
def main():
    ...
    can2.create_image(-10,can2.canvasy(-(80-30+40)),image=wallpaper,anchor="nw")
    can2.create_image(-10,can2.canvasy(-(80-30+40))+h,image=wallpaper,anchor="nw")
    create_rectangle(can2,0, int(can2.canvasy(0))-h, int(can2["width"]), int(can2.canvasy(int(can2["height"])))+h, fill='#000000', alpha=.7)
    ...
    if st==0:
        ...
        for song in all_songs:
            ...
            if not song.lower().find(search_var.lower())==-1:
                ...
                if song==current_playing:
                    ...
                    can2.create_line(0,y, int(can2["width"]),y,fill="#111111")
                ...
                can2.create_text(10+30+20,y+25,text=song[:60]+ex,font=("FreeMono",13),fill=col,anchor="w")
                ...
                if not song==current_playing:
                    ...
                    can2.create_line(0,y+50,w-20-7,y+50,fill="#0d4d2e")
        ...
        if playlist_st==0:
            ...
            if _search==1:
                ...
                can.create_oval(10,40, 10+30,40+30,fill="#111111",outline="#111111")
                can.create_oval(w-10-30,40, w-10,40+30,fill="#111111",outline="#111111")

                can.create_rectangle(10+15,40, w-10-15,40+30,fill="#111111",outline="#111111")
            ...
            draw_round_rec(can,10-2,80-10-30+40,w-10,80-30+40+390+10,15,"#32fca7","",1)
            ...
            if _npl==1:
                ...
                can2.create_oval(10,y, 10+30,y+30, fill="#111111",outline="#111111")
                can2.create_oval(int(can2["width"])-10-30,y, int(can2["width"])-10,y+30,fill="#111111",outline="#111111")

                can2.create_rectangle(10+15,y, int(can2["width"])-10-15,y+30,fill="#111111",outline="#111111")
            ...
            can2.create_line(0,y, int(can2["width"]),y,fill="#0d4d2e")
            ...
            for pl in playlist:
                ...
                if not pl.lower().find(search_var.lower())==-1:
                    ...
                    if current_playlist!=pl:
                        can2.create_line(0,y+50, int(can2["width"]),y+50,fill="#0d4d2e")
        ...
        for song in ar_:
            ...
            can2.create_text(10+30+20,y+25,text=song[0][:60]+ex,font=("FreeMono",13),fill=col,anchor="w")
    ...
    if lst==1:
        ...
        if st==2 and playlist_st==0 and pl_st==0:
            ...
            #draw_round_rec(can,10,40, w-10,40+30,10,"#111111","#32fca7",0)
    ...
    if playlist_st==0 and st==2 and pl_st==0 :
        ...
        if len(current_playlist)>0:
            ...
            can.create_text(10,h-20-60-20-27,text="["+current_playlist+"] ~ "+current_playing,font=("FreeMono",13),anchor="w",fill="#32fca7")
        else:
            can.create_text(10,h-20-60-20-27,text=current_playing,font=("FreeMono",13),anchor="w",fill="#32fca7")


    can.create_line(10,h-20-60-20,w-10,h-20-60-20,fill="#777777",width=4)
...
can=tk.Canvas(width=w,height=h,bg="#111111",relief="flat",highlightthickness=0,border=0)
...
can4=tk.Canvas(frame2,bg="#222222",width=350,height=40,relief="flat",highlightthickness=0,border=0,
...
can4.create_polygon(ar,fill="#111111",outline="#111111")
...
can5.create_polygon(ar,fill="#111111",outline="#111111")
...
search=tk.Entry(bg="#111111",fg="#32fca7",insertbackground="#32fca7",relief="flat",highlightthickness=0,border=0,width=86,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#111111",fg="#32fca7",insertbackground="#32fca7",relief="flat",highlightthickness=0,border=0,width=85,font=("FreeMono",13))
...
sort_st=0
_sort=0
can_sort=tk.Canvas(bg="#222222",width=250,height=160,relief="flat",highlightthickness=0,border=0)
...
can_sort.create_polygon(ar,fill="#111111",outline="#111111")
...
cx,cy=int(can_sort["width"])-r,y+r
...
cx,cy=int(can_sort["width"])-r,y+160-r
...
can_sort.create_line(0,30, 250,30,fill="#32fca7" )
...
for _ in a:
    ...
    can_sort.create_line(0,y+30,250,y+30,fill="#111111")

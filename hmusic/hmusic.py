...
def load_im():
    ...
    draw.polygon(ar,fill=(int(col[0]*0.1),int(col[1]*0.1),int(col[2]*0.1),int(round(0.8*255,0))),outline=(int(col[0]*0.1),int(col[1]*0.1),int(col[2]*0.1),int(round(0.8*255,0))))

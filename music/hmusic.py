        ...
        try:
            ...
            try:
                ...
                if lst==0 and st!=4:
                    ...
                    sig_=can.create_line(sig2,fill="#f94449")
            except:
                pass
...
def convert_folder_to_audio():
    ...
    if convert==1:
        ...
        if st==4:
            ...
            load=can.create_text(w/2,493-20-40-30,text="...",font=("FreeMono",25),fill="#f94449")
        ...
        if st==4:
            ...
            load2=can.create_oval(w/2-50,493-20-40-30-15, w/2-50+30,493-20-40-30+15,fill="#f94449",outline="#f94449")
...
def prog():
    ...
    ctime=can.create_text(10,h-20-60-20+20,text=tt,font=("FreeMono",13),fill="#f94449",anchor="w")
...
def can_b1(e):
    ...
    if 10<=e.x<=w-10-5-30:
        if 40<=e.y<=40+30:
            ...
            can.create_arc(10,40, 10+30,40+30, style=tk.ARC,start=90,extent=180,outline="#f94449")
            can.create_arc(w-10-30,40, w-10,40+30, style=tk.ARC,start=270,extent=180,outline="#f94449")

            can.create_line(10+15,40, w-10-15,40, fill="#f94449")
            can.create_line(10-1+15,40+30, w-10-15,40+30, fill="#f94449")
    ...
    if r<=15:
        ...
        if add_st==0:
            ...
            for p in playlist:
                ...
                can3.create_image(10,y+10,image=playlist2,anchor="nw")
                can3.create_text(10+30+10,y+25,text=p,font=("FreeMono",13),anchor="w",fill="#f94449")
                can3.create_line(0,y+50,350-7,y+50,fill="#f94449")
    ...
    if st==4:
        ...
        #can.create_rectangle(w/2-150,yv, w/2+150,yv+30, fill="#f94449")
...
def main():
    ...
    for l in range(len(label)):
        ...
        if l==st:
            ...
            can.create_rectangle(x-60+15,5, x+60-15,35-1, fill="#f94449",outline="#f94449")
    ...
    if lst==1:
        ...
        can.create_line(5,80-30+40+5+int(can2["height"]),w-7,80-30+40+5+int(can2["height"]),fill="#610400")
    ...
    if st==0:
        ...
        if len(songs)==0:
            current_playing=""
            can2.create_text((w-7)/2,(440*h/680)/2,text="No Record!",font=("FreeMono",13),fill="#f94449")
    elif st==1:
        songs=[]
        ...
        if playlist_st==0:
            ...
            #can.create_line(10,70,w-10,70,fill="#f94449")
            #can.create_line(10,80+h-240+10,w-10,80+h-240+10,fill="#f94449")
            ...
            can2.create_arc(10,y, 10+30,y+30, style=tk.ARC,start=90,extent=180,outline="#f94449")
            can2.create_arc(int(can2["width"])-10-30,y, int(can2["width"])-10,y+30, style=tk.ARC,start=270,extent=180,outline="#f94449")

            can2.create_line(10+15,y, int(can2["width"])-10-15,y, fill="#f94449")
            can2.create_line(10-1+15,y+30, int(can2["width"])-10-15,y+30, fill="#f94449")
            ...
            can2.create_text(30,y+15,text="New Playlist",font=("FreeMono",13),fill="#f94449",anchor="w")
            ...
            #can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30, outline="#f94449")

            can2.create_image(int(can2["width"])/2-100-15,y,image=circle3,anchor="nw")
            can2.create_image(int(can2["width"])/2+100-15,y,image=circle3,anchor="nw")

            can2.create_rectangle(int(can2["width"])/2-100,y, int(can2["width"])/2+100,y+30-1,fill="#f94449",outline="#f94449")
            ...
            if len(_playlist)==0:
                current_playing=""
                can2.create_text(int(can2["width"])/2,y+((440*h/680)-y)/2,text="No Record",font=("FreeMono",13),fill="#f94449")
        ...
        can.create_rectangle(w/2-150,yv, w/2+150,yv+30-1,fill="#f94449",outline="#f94449")
        ...
        can.create_rectangle(w/2-150,yv+60, w/2+150,yv+30-1+60,fill="#f94449",outline="#f94449")
    ...
    if st==2 and playlist_st==0:
        ...
        can.create_text(w-10,h-20-60-20+20,text=tot_tm,font=("FreeMono",13),anchor="e",fill="#f94449")
...
def load_():
    ...
    if st==4 and load_st==1:
        ...
        load=can.create_arc(w/2-20,493-20-40, w/2+20,493-20,outline="#f94449",width=2,style=tk.ARC,start=load_ang,extent=270)
...
style2.configure("My.Vertical.TScrollbar2", gripcount=0, background="#f94449",

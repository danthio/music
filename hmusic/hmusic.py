...
def get_amplitude_at_time(file_path, time_sec):
    ...
    with wave.open(file_path, 'rb') as wav_file:
        ...
        # Set the read position to the desi#ff00ff frame
...
def add_playlist():
    ...
    for p in playlist:
        ...
        #can3.create_line(0,y+50,450-7,y+50,fill="#200020")
            ...
            if cy-12.5<=e.y<=cy+12.5:
                ...
                if sort_st==1:
                    ...
                    for _ in sa:
                        ...
                        #can_sort.create_line(0,y+30,250,y+30,fill="#200020")
...
def play_music(file,time,con=0):
    ...
    if play_st==1:
        ...
        start_time = time  # Replace with the desi#ff00ff starting time in seconds
...
def main():
    ...
    #cp_im=create_polygon(*ar, fill="#ff00ff", alpha=0.6,can=can2)
    ...
    if select_st==1:
        ...
        if len(songs2)==0:
            ...
            style.configure("My.Vertical.TScrollbar", gripcount=0, background="#200020",
                            troughcolor="#200020", borderwidth=0, bordercolor="#200020",
                            lightcolor="#200020",relief="flat", darkcolor="#200020",
                            arrowsize=6)
        ...
        #hex(can,-30,-30,w+60,h+60,30,"#390200","#200020")
        ...
        #can2.create_image(-10,can2.canvasy(-(80-30+40))+h,image=wallpaper,anchor="nw")
        #create_rectangle(can2,0, int(can2.canvasy(0))-h, int(can2["width"]), int(can2.canvasy(int(can2["height"])))+h, fill='#200020', alpha=.65)
        ...
        if st==0:
            ...
            if playlist_st==0:
                ...
                create_polygon(*ar, fill="#ff00ff", alpha=0.4,can=can2)

                if _npl==1:

                    can2.create_oval(10,y, 10+30,y+30, fill="#550055",outline="#550055")
                    can2.create_oval((int(can2["width"])-sb_sz-1)-10-30,y, (int(can2["width"])-sb_sz-1)-10,y+30,fill="#550055",outline="#550055")

                    can2.create_rectangle(10+15,y, (int(can2["width"])-sb_sz-1)-10-15,y+30,fill="#550055",outline="#550055")
                ...
                can2.create_text((int(can2["width"])-sb_sz-1)/2,y+15,text="Create New Playlist",font=("FreeMono",12),fill="#200020")
        ...
        """
        if y<=((h-121)-80-10):
            hex(can2,-30,-30,w+60,int(can2["height"])+60,30,"#390200","#200020")


        else:

            hex(can2,-30,-30,w+60,y+60,30,"#390200","#200020")
    ...
    draw_round_rec(can,0,0,w-1,h-1,30,"#aa00aa","",1)
...
def draw_can():
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",12),fill="#ff00ff")
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",12),fill="#200020")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            create_polygon(*ar, fill="#ff00ff", alpha=0.4,can=can)
            
            if _search==1:

                can.create_oval(10,40+30-10-5-5, 10+30,40+30+30-10-5-5,fill="#550055",outline="#550055")
                can.create_oval(w-10-30-1,40+30-10-5-5, w-10-1,40+30+30-10-5-5,fill="#550055",outline="#550055")

                can.create_rectangle(10+15,40+30-10-5-5, w-10-15-1,40+30+30-10-5-5,fill="#550055",outline="#550055")
        ...
        if playlist_st==0 and st==2 and pl_st==0 and current_playing=="":
            ...
            try:
                ...
                if songs_status[1]!="":
                        ...
                        can.create_text(10+15+30,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=current_playlist_,font=("FreeMono",12,),anchor="w",fill="#200020")
    ...
    if st==4:
        ...
        can.create_text(w/2,yv+15,text="Add Folder",fill="#200020",font=("FreeMono",12))
        ...
        can.create_text(w/2,yv+15+60,text="Add Audio File",fill="#200020",font=("FreeMono",12))
...
def drag_can(e):
    ...
    if v_st==1:
        ...
        if w-10-100<=e.x<=w-10:
            ...
            vol1=can.create_line(w-10-100,h-20-30+5+10-3 ,w-10-100+current_volume*r,h-20-30+5+10-3,fill="#ff00ff",width=2)

            vol2=can.create_text(w-10,h-20-30+5+10-3+12,text=str(int(current_volume*100))+"%",fill="#ff00ff",font=("FreeMono",11),anchor="e")
...
can=tk.Canvas(width=w,height=h,bg="#200020",relief="flat",highlightthickness=0,border=0,cursor="arrow")
...
frame=tk.Frame(bg="#200020",width=w-20,height=((h-121)-80-10))
...
can2=tk.Canvas(frame,bg="#200020",width=w-20,height=((h-121)-80-10),relief="flat",highlightthickness=0,border=0)
can2["scrollregion"]=(0,0,int(can2["width"]),int(can2["height"]))
...
frame2=tk.Frame(bg="#200020",width=350+100,height=250)

can4=tk.Canvas(frame2,bg="#200020",width=350+100,height=40,relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,300-7,250))
can4.pack(side=tk.TOP)



frame3=tk.Frame(frame2,bg="#200020",width=350+100,height=250-40)
...
psb2_h=0
sb2_st=0
can3=tk.Canvas(frame3,bg="#200020",width=350+100,height=250-40,relief="flat",highlightthickness=0,border=0,
...
can6=tk.Canvas(frame2,bg="#200020",width=350+100,height=17,relief="flat",highlightthickness=0,border=0)
...
search=tk.Entry(bg="#550055",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=115,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#550055",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=112,font=("FreeMono",13))
...
sort_st=0
_sort=0
can_sort=tk.Canvas(bg="#200020",width=250,height=160,relief="flat",highlightthickness=0,border=0)
...
can_lyrics=tk.Canvas(bg="#200020",relief="flat",highlightthickness=0,border=0)

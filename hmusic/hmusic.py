...
def main():
    ...
    style2.configure("My.Vertical.TScrollbar2", gripcount=0, background=col1,
                    troughcolor='#351406', borderwidth=0, bordercolor='#351406',
                    lightcolor='#351406',relief="flat", darkcolor='#351406',
                    arrowsize=6)
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                if music_details[current_playing][2]!="":
                    can.create_image(x+40+10-5+25+10,y+2.5,image=delete,anchor="nw")
        ...
        if lst==0:
            ...
            if not current_playing=="":
                ...
                if not _lyric_=="":
                    ...
                    can.create_text(w/2,50+(((h-121)-50)-420)/2+210,text="Nothing to show!",fill=col1,font=("FreeMono",12))

    ...
    if select_st==1:
        ...
        if st==0:
            ...
            if playlist_st==0:
                ...
                create_polygon(*ar, fill="#ff1f83", alpha=0.5,can=can2)
                ...
                can2.create_text(30,y+15,text="New Playlist",font=("FreeMono",13),fill="#200310",anchor="w")
                ...
                if _npl==1:
                    ...
                    can2.create_image((int(can2["width"])-sb_sz-1)-10-5-20,y+5,image=cancel2,anchor="nw")
                ...
                can2.create_text((int(can2["width"])-sb_sz-1)/2,y+15,text="Create New Playlist",font=("FreeMono",13),fill="#19030d")
...
def draw_can():
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",13),fill="#19030d")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            create_polygon(*ar, fill="#ff1f83", alpha=0.5,can=can)
            ...
            if _search==1:
                ...
                can.create_image(w-10-5-20,40+5+30-10-5-5,image=cancel2,anchor="nw")


            can.create_text(10+15+20+10,40+15+30-10-5-5,text="Search",font=("FreeMono",13),fill="#200310",anchor="w")



            can.create_image(10+15,45+30-10-5-5,image=search_im,anchor="nw")
        ...
        if playlist_st==0 and st==2 and pl_st==0 and current_playing=="":
            ...
            try:
                ...
                if songs_status[1]!="":
                        ...
                        can.create_text(10+15+30,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=current_playlist_,font=("FreeMono",13,),anchor="w",fill="#19030d")
    ...
    if st==4:
        ...
        can.create_text(w/2,yv+15,text="Add Folder",fill="#19030d",font=("FreeMono",13))
        ...
        can.create_text(w/2,yv+15+60,text="Add Audio File",fill="#19030d",font=("FreeMono",13))

...
def prog():
    ...
    prog1=can.create_line(10,h-20-60-20, x_+10,h-20-60-20,fill="#32fca7",width=3)
...
def can_b1(e):
    ...
    cx,cy=10+30+20+30+20+30+20+15,h-20-30-15+5+15
...
def main():
    ...
    global songs
    global search,search_var
    global cancel,search_im,shuffle1,shuffle2,dots,note,playlist1,playlist2,sort,delete,favourite1_,favourite2_,delete2,playlist3
    global music_details
    ...
    for l in range(len(label)):
        ...
        if l==st:
            ...
            can.create_arc(x-60,5, x-60+30,5+30,start=90,extent=180,outline="#32fca7",fill="#32fca7")
            can.create_arc(x+60,5, x+60-30,5+30,start=270,extent=180,outline="#32fca7",fill="#32fca7")

            can.create_rectangle(x-60+15,5, x+60-15,35, fill="#32fca7",outline="#32fca7")
    ...
    def round_(r,y):
        ...
        can2.create_polygon(ar,fill="#000000",outline="#000000")
        ...
        for song in all_songs:
            ...
            if not song.lower().find(search_var.lower())==-1:
                ...
                if song==current_playing:
                    ...
                    can2.create_rectangle(0,y, int(can2["width"]),y+50,fill="#32fca7",outline="#32fca7")
                    round_(7,y)
        ...
        if playlist_st==0:
            ...
            for pl in playlist:
                ...
                if not pl.lower().find(search_var.lower())==-1:
                    ...
                    can2.create_image(int(can2["width"])-10-20,y+15,image=cancel,anchor="nw")
    ...
    can.create_line(10,h-20-60-20,w-10,h-20-60-20,fill="#777777",width=3)
    ...
    if loop==0:
        can.create_image(10+30+20+30+20+30+20,h-20-30-15+5,image=loop1,anchor="nw")

    elif loop==1:
        can.create_image(10+30+20+30+20+30+20,h-20-30-15+5,image=loop2,anchor="nw")
...
def load_im():
    ...
    global circle,play,pause,add,favourite1,favourite2,list1,list2,musical_note1,musical_note2,remove,rename,speaker,previous,next_
    global cancel,search_im,shuffle1,shuffle2,dots,note,playlist1,playlist2,checked,sort,delete,favourite1_,favourite2_,delete2,playlist3,sort2,loop1,loop2

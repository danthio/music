...
def main():
        ...
        for song in all_songs:
            ...
            if not song.lower().find(search_var.lower())==-1:
                ...
                if song==current_playing:
                    ...
                    can2.create_rectangle(w-20-7-10-30-20-30-20-30-10,y+5, w-20-7,y+45,fill="#111111",outline="#111111")
    ...
    can.create_line(w-10-100,h-20-30+5, w-10,h-20-30+5,fill="#777777",width=3)
...
can4.create_line(0,38,350,38,fill="#111111")

frame3=tk.Frame(frame2,bg="#000000",width=350,height=250-40)

can3=tk.Canvas(frame3,bg="#000000",width=350-7,height=250-40,relief="flat",highlightthickness=0,border=0,
...
can5=tk.Canvas(frame2,bg="#000000",width=350,height=10,relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,300-7,250))
...
can_sort.create_line(0,30, 250,30,fill="#111111" )

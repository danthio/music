...
def add_playlist():
    ...
    for p in playlist:
        ...
        #can3.create_line(0,y+50,450-7,y+50,fill="#000c16")
            ...
            if cy-12.5<=e.y<=cy+12.5:
                ...
                if sort_st==1:
                    ...
                    for _ in sa:
                        ...
                        #can_sort.create_line(0,y+30,250,y+30,fill="#000c16")
...
def main():
    ...
    style.configure("My.Vertical.TScrollbar", gripcount=0, background=col1,
                    troughcolor="#045366", borderwidth=0, bordercolor="#045366",
                    lightcolor="#045366",relief="flat", darkcolor="#045366",
                    arrowsize=6)
    ...
    if select_st==1:
        ...
        if len(songs2)==0:
            ...
            style.configure("My.Vertical.TScrollbar", gripcount=0, background="#000c16",
                            troughcolor="#000c16", borderwidth=0, bordercolor="#000c16",
                            lightcolor="#000c16",relief="flat", darkcolor="#000c16",
                            arrowsize=6)
        ...
        #hex(can,-30,-30,w+60,h+60,30,"#390200","#000c16")
        ...
        #can2.create_image(-10,can2.canvasy(-(80-30+40))+h,image=wallpaper,anchor="nw")
        #create_rectangle(can2,0, int(can2.canvasy(0))-h, int(can2["width"]), int(can2.canvasy(int(can2["height"])))+h, fill='#000c16', alpha=.65)
        ...
        if st==0:
            ...
            for song in all_songs:
                ...
                if scon==1:
                    ...
                    if song==current_playing:
                        ...
                        can2.create_line(2,y, int(can2["width"]),y,fill="#000c16")
                    ...
                    can2.create_text(50,y+50/2,text=_text_(can2,song[:-4],"FreeMono",12,(int(can2["width"])-25*3-15*3-10)-50),font=("FreeMono",12),fill=col,anchor="w")
            ...
            if len(songs)==0:
                ...
                can2.create_text(int(can2["width"])/2,int(can2["height"])/2,text="No Record!",font=("FreeMono",25),fill=col1)
            ...
            if playlist_st==0:
                ...
                a_=0
                for a in range(180):
                    x=15*math.sin(math.radians(a_))+int(can2["width"])-10-15
                    y_=15*math.cos(math.radians(a_))+y+15
                ...
                if _npl==1:
                    ...
                    can2.create_oval(10,y, 10+30,y+30, fill="#000c16",outline="#000c16")
                    can2.create_oval(int(can2["width"])-10-30,y, int(can2["width"])-10,y+30,fill="#000c16",outline="#000c16")

                    can2.create_rectangle(10+15,y, int(can2["width"])-10-15,y+30,fill="#000c16",outline="#000c16")
                ...
                can2.create_text(int(can2["width"])/2,y+15,text="Create New Playlist",font=("FreeMono",12),fill="#000c16")
                ...
                for pl in playlist:
                    ...
                    if scon==1:
                        ...
                        can2.create_text(50,y+25,text=_text_(can2,pl,"FreeMono",12,(int(can2["width"])-25*2-15*2-10)-50),font=("FreeMono",12),fill=col,anchor="w")
            ...
            for song in ar_:
                ...
                can2.create_text(50,y+50/2,text=_text_(can2,song[0][:-4],"FreeMono",12,(int(can2["width"])-25*3-15*3-10)-50),font=("FreeMono",12),fill=col,anchor="w")
        ...
        """
        if y<=((h-121)-80-10):
            hex(can2,-30,-30,w+60,int(can2["height"])+60,30,"#390200","#000c16")


        else:

            hex(can2,-30,-30,w+60,y+60,30,"#390200","#000c16")
    ...
    draw_round_rec(can,0,0,w-1,h-1,35,col1,"",1)
...
def draw_can():
    ...
    draw_round_rec2(can,0,0,w-1,h-1,35,"#333333")
    ...
    if lst==0:
        ...
        if not st==4:
            ...
            if lyric_st==0:
                ...
                can.create_text(x,y+15,text="Lyrics",font=("FreeMono",12),fill="#000c16")


                can.create_image(x+40+10+5,y+2.5,image=copy,anchor="nw")
    ...
    if lst==1:
        ...
        if st==4:
            ...
            if _search==1:
                ...
                can.create_oval(10,40+30-10-5-5, 10+30,40+30+30-10-5-5,fill="#000c16",outline="#000c16")
                can.create_oval(w-10-30-1,40+30-10-5-5, w-10-1,40+30+30-10-5-5,fill="#000c16",outline="#000c16")

                can.create_rectangle(10+15,40+30-10-5-5, w-10-15-1,40+30+30-10-5-5,fill="#000c16",outline="#000c16")
        ...
        if playlist_st==0 and st==2 and pl_st==0 and current_playing=="":
            ...
            try:
                ...
                if songs_status[1]!="":
                        ...
                        can.create_text(10+15+30,h-20-60-20-27-15+3+10+3+2+2-3+15+10,text=current_playlist_,font=("FreeMono",12,),anchor="w",fill="#000c16")
    ...
    if st==4:
        ...
        can.create_text(w/2,yv+15,text="Add Folder",fill="#000c16",font=("FreeMono",12))
        ...
        can.create_text(w/2,yv+15+60,text="Add Audio File",fill="#000c16",font=("FreeMono",12))
...
can=tk.Canvas(width=w,height=h,bg="#000c16",relief="flat",highlightthickness=0,border=0,cursor="arrow")
...
frame=tk.Frame(bg="#000c16",width=w-20,height=((h-121)-80-10))

can2=tk.Canvas(frame,bg="#000c16",width=w-20,height=((h-121)-80-10),relief="flat",highlightthickness=0,border=0)
can2["scrollregion"]=(0,0,int(can2["width"]),int(can2["height"]))
...
frame2=tk.Frame(bg="#000c16",width=350+100,height=250)

can4=tk.Canvas(frame2,bg="#000c16",width=350+100,height=40,relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,300-7,250))
can4.pack(side=tk.TOP)



frame3=tk.Frame(frame2,bg="#000c16",width=350+100,height=250-40)

can3=tk.Canvas(frame3,bg="#000c16",width=350+100-5-2-1,height=250-40,relief="flat",highlightthickness=0,border=0,
...
can5=tk.Canvas(frame3,bg="#000c16",width=2,height=250-40,relief="flat",highlightthickness=0,border=0)
...
can6=tk.Canvas(frame2,bg="#000c16",width=350+100,height=17,relief="flat",highlightthickness=0,border=0)
...
search=tk.Entry(bg="#000c16",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=115,font=("FreeMono",13))
#search.bind("<KeyPress>",search_keypress)
npl=tk.Entry(bg="#000c16",fg=col1,insertbackground=col1,relief="flat",highlightthickness=0,border=0,width=112,font=("FreeMono",13))
...
sort_st=0
_sort=0
can_sort=tk.Canvas(bg="#000c16",width=250,height=160,relief="flat",highlightthickness=0,border=0)
...
can_lyrics=tk.Canvas(bg="#000c16",relief="flat",highlightthickness=0,border=0)

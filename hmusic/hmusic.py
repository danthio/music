...
def draw_can():
    ...
    if theme_st==1:
        ...
        can.create_image(x,y, image=circle8,anchor="nw")
        can.create_image(x+75+35-40,y, image=circle8,anchor="nw")

        can.create_rectangle(x+20,y, x+75+35-20,y+40-1,fill=col2,outline=col2)
...
def load_im():
    ...
    circle8=ImageTk.PhotoImage(file="data/"+theme+"/circle8.png")
    circle9=ImageTk.PhotoImage(file="data/"+theme+"/circle9.png")
    circle10=ImageTk.PhotoImage(file="data/"+theme+"/circle10.png")
    ...
    headphones=ImageTk.PhotoImage(file="data/"+theme+"/headphones.png")
    headphones2=ImageTk.PhotoImage(file="data/"+theme+"/headphones2.png")
    ...
    forward=ImageTk.PhotoImage(file="data/"+theme+"/forward.png")
    backward=ImageTk.PhotoImage(file="data/"+theme+"/backward.png")

...
def main():
    ...
    _bg2_=can2.create_image(-10,-(90-1)+can2.canvasy(0),image=bg,anchor="nw")
    _bg4_=can2.create_image((w-450)/2-10,50+((h-121-50)-450)/2-(90-1)+can2.canvasy(0),image=note,anchor="nw")
...
def move_bg():
    ...
    try:
        ...
        if not can2_y==can2.canvasy(0):
            ...
            can2.coords(_bg2_,-10,-(90-1)+can2.canvasy(0))
            can2.coords(_bg4_,(w-450)/2-10,50+((h-121-50)-450)/2-(90-1)+can2.canvasy(0))

        ...
        try:
            ...
            if cap is not None and cap.isOpened() and not paused:
                ...
                if ret:
                    ...
                    frame = cv2.resize(frame, (w-20, (h-133)-55))
        ...
        if play_video_st==0:
            ...
            try:
                ...
                for a in sig:
                    ...
                    sig2.append(x)
                    sig2.append(a+(80-30+40-10-30)+(((h-133)-97-20)+10+30)/2+30-3)
    ...
    if st==2 and playlist_st==0:
        ...
        if 10<=e.x<=int(can2["width"])-10:
            if 5<=e.y<=35:
                ...
                can2["scrollregion"]=(0,0,w-7,((h-133)-97-20))
                npl.delete(0,tk.END)
                _npl=1
    ...
    if not current_playing=="":
        ...
        for s in songs:
            ...
            if s[0]==current_playing:
                ...
                if s[1]+((h-133)-97-20)/2-25<t:
                    v=s[1]-(((h-133)-97-20)/2-25)
...
def can_b1(e):
    ...
    if con==0:
        ...
        cx,cy=w/2+30+30+30+20+10+12.5,h-20-30-15+5+12.5+10-3+2.5
...
def main():
    ...
    style.configure("My.Vertical.TScrollbar", gripcount=0, background=col1,
                    troughcolor=col4, borderwidth=0, bordercolor=col4,
                    lightcolor=col4,relief="flat", darkcolor=col4,
                    arrowsize=7)
    ...
    frame["width"]=w-20-2
    frame["height"]=((h-133)-97-20)

    can2["width"]=w-7-20-2
    can2["height"]=((h-133)-97-20)
    ...
    if select_st==1:
        ...
        for song in all_songs:
            ...
            if scon==1:
                ...
                can2.create_rectangle(int(can2["width"])-20-20-20,y+5, int(can2["width"]),y+45,fill=col4,outline=col4)
        ...
        if len(songs2)==0:
            can2.create_text((w-7)/2,((h-133)-97-20)/2,text="No Record!",font=("FreeMono",13),fill=col1)
        ...
        if st==0:
            ...
            for song in all_songs:
                ...
                if scon==1:
                    ...
                    if song==current_playing:
                        ...
                        can2.create_rectangle(0,y, int(can2["width"]),y+50-1,fill=col1,outline=col1)
                    ...
                    if song==current_playing:
                        ...
                        can2.create_rectangle(int(can2["width"])-25*3-15*3,y+5, int(can2["width"]),y+45,fill=col4,outline=col4)
            ...
            if len(songs)==0:
                ...
                can2.create_text(int(can2["width"])/2,((h-133)-97-20)/2,text="No Record!",font=("FreeMono",13),fill=col1)
            ...
            if playlist_st==0:
                ...
                if len(_playlist)==0:
                    ...
                    can2.create_text(int(can2["width"])/2,y+(((h-133)-97-20)-y)/2,text="No Record",font=("FreeMono",13),fill=col1)
                    ...
                    if scon==1:
                        ...
                        try:
                            ...
                            if song==current_playing:
                                ...
                                can2.create_rectangle(int(can2["width"])-25*4-15*3,y+3, int(can2["width"]),y+45,fill=col4,outline=col4)
...
def draw_can():
    ...
    global circle2,circle3,circle4,circle5
    ...
    if lst==1:
        ...
        if playlist_st==0 and st==2:
            ...
            can.create_image((w-420)/2,39+(((h-133)-97-20)+10+30)/2-210+10+15-3,image=note,anchor="nw")
    ...
    for l in range(len(label)):
        ...
        can.create_text(x,55/2,text=label[l],fill=col,font=("FreeMono",13),anchor="c")
    ...
    if st==4 or select_st==1:
        ...
        if playlist_st==0 and st==2 and pl_st==0 and current_playing=="":
            ...
            if len(current_playlist)>0:
                ...
                can.create_text(10+15+30,h-20-60-20-27-15+3+10+3+2+2-3+15,text=current_playlist,font=("FreeMono",13,),anchor="w",fill="#000000")
                      
                can.create_text(10+15+length_in_pixels+15+10+30,h-20-60-20-27-15+3+10+3+2+2-3+15,text=current_playing[:-4],font=("FreeMono",13),anchor="w",fill=col1)
            else:
                can.create_text(10,h-20-60-20-27-15+3+10+3+2+2-3+15,text=current_playing[:-4],font=("FreeMono",13),anchor="w",fill=col1)
...
\
        ...
        can.create_image(w-10-100-10-30+5,h-20-30-15+5+10-3,image=circle5,anchor="nw")
        ...
        if loop==0:
            can.create_image(w/2+30+30+30+20+10,h-20-30-15+5+10-3+2.5,image=circle5,anchor="nw")
            can.create_image(w/2+30+30+30+20+10,h-20-30-15+5+10-3+2.5,image=loop1,anchor="nw")

        elif loop==1:

            can.create_image(w/2+30+30+30+20+10,h-20-30-15+5+10-3+2.5,image=circle5,anchor="nw")
            can.create_image(w/2+30+30+30+20+10,h-20-30-15+5+10-3+2.5,image=loop2,anchor="nw")
    ...
    if st==4:
        ...
        can.create_image((w-420)/2,39+(((h-133)-97-20)+10+30)/2-210+10+15,image=note,anchor="nw")
        frame.place_forget()
        ...
        if lst==0:
            ...
            if not current_playing=="":
                ...
                if not _lyric_=="":
                    ...
                    text.place(in_=root,x=(w-(790-111))/2,y=h-145-30-5-450+10)



                    draw_round_rec(can,(w-(820-126))/2,h-145-30-5-450 ,(w-(820-126))/2+(820-126),h-145-30-5,15,col1,col1,0)
...
def load_im():
    ...
    global circle2,circle3,circle4,circle5,expand,expand2,playlist4
...
def _on_mousewheel(e):
    ...
    if add_st==0 and lst==1:
        ...
        if int(can2["scrollregion"].split(" ")[-1])>((h-133)-97-20):
...
def play_next(e):
    ...
    if st==2 and playlist_st==0:
        can2["scrollregion"]=(0,0,w-7-2,((h-133)-97-20))
...
frame=tk.Frame(bg="#000000",width=w-20-2,height=((h-133)-97-20))

can2=tk.Canvas(frame,bg="#000000",width=w-7-20-2,height=((h-133)-97-20),relief="flat",highlightthickness=0,border=0,
    scrollregion=(0,0,w-7-2,((h-133)-97-20)))
...
move_to_playing()
if playlist_st==0:
    pass#can2["scrollregion"]=(0,0,w-7,((h-133)-97-20))
